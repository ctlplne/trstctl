...
// Version-one connector receipts have no per-invocation completion authority.
// Keep their import/privacy payload closed when adding that evidence in v2.
type privacyConnectorDeliveryRecordedV1 struct {
	ID               string  `json:"id"`
...
func exactProjectorPrivacyPolicies() map[privacyEventPolicyKey]events.PrivacyEventPolicy {
	...
	agentHeartbeat := privacyRules(
		...
		privacyRule("/relay_plugins/plugins/*/name", opaque),
		privacyRule("/relay_plugins/plugins/*/digest", opaque),
		privacyRule("/relay_plugins/plugins/*/publisher", opaque),
		privacyRule("/relay_plugins/plugins/*/execution_context", opaque),
		privacyRule("/relay_plugins/plugins/*/grants/*/capability", opaque),
		privacyRule("/relay_plugins/plugins/*/grants/*/constraints/*", opaque),
		privacyRule("/relay_plugins/issued_at_unix", opaque),
		privacyRule("/relay_plugins/signature", opaque),
		privacyRule("/relay_plugins/statement", opaque),
		privacyRule("/relay_plugins/signer_fingerprint", opaque),
		privacyRule("/revocation_caches/entries/*/cache_id", opaque),
		privacyRule("/revocation_caches/entries/*/segment", opaque),
		privacyRule("/revocation_caches/entries/*/protocol", opaque),
		privacyRule("/revocation_caches/entries/*/issuer_fingerprint", opaque),
		privacyRule("/revocation_caches/entries/*/local_path", opaque),
		privacyRule("/revocation_caches/entries/*/status", opaque),
		privacyRule("/revocation_caches/entries/*/detail_code", opaque),
		privacyRule("/revocation_caches/entries/*/cached_responses", opaque),
		privacyRule("/revocation_caches/entries/*/fresh", opaque),
		privacyRule("/revocation_caches/entries/*/signature_verified", opaque),
		privacyRule("/revocation_caches/entries/*/this_update_unix", opaque),
		privacyRule("/revocation_caches/entries/*/next_update_unix", opaque),
		privacyRule("/revocation_caches/entries/*/last_validated_at_unix", opaque),
		privacyRule("/revocation_caches/entries/*/served_requests", opaque),
		privacyRule("/revocation_caches/entries/*/refused_requests", opaque),
		privacyRule("/revocation_caches/issued_at_unix", opaque),
		privacyRule("/revocation_caches/signature", opaque),
		privacyRule("/revocation_caches/statement", opaque),
		privacyRule("/revocation_caches/signer_fingerprint", opaque),
	)
	...
	policies := map[privacyEventPolicyKey]events.PrivacyEventPolicy{
		...
		{EventFirstIssuanceRetryRequested, 1}: privacyRules(
			privacyRule("/event_id", opaque), privacyRule("/identity_id", opaque),
			privacyRule("/request_key", opaque), privacyRule("/outbox_id", opaque),
			privacyRule("/original_payload_sha256", opaque), privacyRule("/attempts", opaque),
		...
		{EventCertificateRevocationBatchApplied, 1}: privacyRules(
			privacyRule("/request_binding", opaque), privacyRule("/reason", opaque),
			privacyRule("/items/*/id", opaque), privacyRule("/items/*/matched", opaque),
			privacyRule("/items/*/status", opaque), privacyRule("/items/*/error", opaque),
			privacyRule("/items/*/fingerprint", opaque), privacyRule("/items/*/serial", opaque),
			privacyRule("/items/*/ca_id", opaque),
			privacyRule("/items/*/external_ca_id", opaque),
		),
		{EventCertificateRevocationBatchApplied, CertificateExternalRevocationSchemaVersion}: privacyRules(
			privacyRule("/request_binding", opaque), privacyRule("/reason", opaque),
			privacyRule("/items/*/id", opaque), privacyRule("/items/*/matched", opaque),
			privacyRule("/items/*/status", opaque), privacyRule("/items/*/error", opaque),
			privacyRule("/items/*/fingerprint", opaque), privacyRule("/items/*/serial", opaque),
...
func projectorPrivacyPayloadShapes() map[privacyEventPolicyKey]events.PrivacyPayloadShape {
	return map[privacyEventPolicyKey]events.PrivacyPayloadShape{
		...
		{EventCMDBSweepDispatched, 1}:                                               privacyPayloadShape[CMDBSweepDispatched](),
		{EventCMDBSweepPageObserved, 1}:                                             privacyPayloadShape[CMDBSweepPageObserved](),
		{EventCMDBSweepFailed, 1}:                                                   privacyPayloadShape[CMDBSweepFailed](),
		{EventTicketIntakeConfigured, 1}:                                            privacyPayloadShape[TicketIntakeConfigured](),
		{EventTicketIntakeSweepDispatched, 1}:                                       privacyPayloadShape[TicketIntakeSweepDispatched](),
		{EventTicketIntakeSweepPageObserved, 1}:                                     privacyPayloadShape[TicketIntakeSweepPageObserved](),
		{EventTicketIntakeSweepFailed, 1}:                                           privacyPayloadShape[TicketIntakeSweepFailed](),
		{EventEnrollmentDiagnosticObserved, 1}:                                      privacyPayloadShape[enrollmentDiagnosticObservedV1](),
		{EventEnrollmentDiagnosticObserved, EnrollmentDiagnosticEventSchemaVersion}: privacyPayloadShape[EnrollmentDiagnosticObserved](),
		{EventEnrollmentDiagnosticVerificationQueued, 1}:                            privacyPayloadShape[EnrollmentDiagnosticVerificationQueued](),
		...
		{EventADCSInventoryObserved, 1}:                                             privacyPayloadShape[adcsdiscovery.InventoryObservedV1](),
		{EventADCSInventoryObserved, adcsdiscovery.InventoryEventSchemaVersion}:     privacyPayloadShape[adcsdiscovery.InventoryObserved](),
		...
		{EventConnectorDeliveryRecorded, 1}:                                        privacyPayloadShape[privacyConnectorDeliveryRecordedV1](),
		{EventConnectorDeliveryRecorded, ConnectorReceiverCompletionSchemaVersion}: privacyPayloadShape[ConnectorDeliveryRecorded](),
		...
		{EventAuditFeedDestinationConfigured, 1}:                                   privacyPayloadShape[AuditFeedDestinationConfigured](),
		{EventAuditFeedScheduleChecked, 1}:                                         privacyPayloadShape[AuditFeedScheduleChecked](),
		{EventAuditFeedBatchQueued, 1}:                                             privacyPayloadShape[AuditFeedBatchQueued](),
		{EventAuditFeedBatchDelivered, 1}:                                          privacyPayloadShape[AuditFeedBatchDelivered](),
		{EventAuditFeedBatchFailed, 1}:                                             privacyPayloadShape[AuditFeedBatchFailed](),
