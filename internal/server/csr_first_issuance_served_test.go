...
func TestServedIssuanceSignsACallerSuppliedCSRAndHoldsNoKey(t *testing.T) {
	...
	// started being served — that summary is the sentence "The private key was
	// generated by the requester; the control plane never held it", i.e. the
	// system correctly REPORTING the absence of a key. A scanner that cannot
