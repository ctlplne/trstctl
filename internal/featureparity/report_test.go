...
func TestRenderControlPanelUsesCanonicalCatalogOnly(t *testing.T) {
	...
	for _, want := range []string{
		...
		// F25, F43, F69, F70, F71, F72, F6, F73, F74, F51, F33, F30, F61, F45, F37, F16, F63, F67, F58, F60, F38, F39, F65, F66, F68, F50, F7, F27, and F32 now join
		// the complete vertical slices with exact live evidence, dedicated console workflows, and recovery.
		"4 release blockers",
		"65 complete vertical slices",
		"Filter capabilities",
		"data-tool=\"secrets\"",
		"F66",
