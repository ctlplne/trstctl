...
func (s *Store) DeleteTenantReadModelTx(ctx context.Context, tx pgx.Tx, tenantID string) error {
	...
	ordered := []string{"identity_transitions", "connector_delivery_receipts", "lifecycle_rotation_runs", "remediation_playbook_runs", "incident_fleet_reissuance_runs", "pam_sessions", "compliance_report_schedules", "access_change_request_decisions", "access_change_requests", "nhi_access_review_items", "nhi_access_review_campaigns", "notification_reads", "notification_threshold_deliveries", "ca_crls", "ca_ocsp_responders", "ca_issued_certs", "ca_ceremony_approvals", "ca_key_ceremonies", "certificates", "crypto_assets", "agent_cert_revocations", "identities", "certificate_profiles", "mdm_scep_policies", "acme_dns01_provider_configs", "discovery_findings", "discovery_runs", "discovery_schedules", "discovery_sources", "privacy_retention_runs", "privacy_subject_erasures", "issuers", "owners", "tenants"}
