...
// Package jobmodel holds the lightweight VDEC dependency-state job model. It is
// intentionally free of outbox, SQL, bus, or HTTP dependencies so signer-side
// components can share deterministic job semantics without linking control-plane
// substrates.
package jobmodel
...
// ValidateJob rejects incomplete jobs and jobs whose action does not match the
// dependent class.
...
// DependentKey returns the canonical key used to de-duplicate dependent objects.
