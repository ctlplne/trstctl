...
var coreCommandTable = []Command{
	...
	{Name: []string{"incidents", "fleet-reissuance", "pause"}, Method: "POST", Path: "/api/v1/incidents/fleet-reissuance-runs/{id}/pause", Body: bodyFile, Summary: "Pause fleet publication at its durable batch cursor"},
	{Name: []string{"incidents", "fleet-reissuance", "resume"}, Method: "POST", Path: "/api/v1/incidents/fleet-reissuance-runs/{id}/resume", Body: bodyFile, Summary: "Resume fleet publication from its durable batch cursor"},
