...
// proof that every REQUIRED internal/agentid constructor is an RTA-reachable node from the
...
//
// Run in CI with: go test -tags agidrta ./internal/agentid/intgate/...
