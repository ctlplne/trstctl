...
// REQUIRED internal/agentid constructor is a REACHABLE node.
//
...
// `go test -tags agidrta ./internal/agentid/intgate/...` to exercise it. The floor
...
// included per the card (its reachable set simply contributes nothing to internal/agentid).
