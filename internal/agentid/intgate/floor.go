...
func moduleRoot() (string, error) {
	// The runtime working directory of `go test ./internal/agentid/intgate/...` is the package
...
// non-test .go files under internal/agentid+cmd+internal.
...
// module-qualified import path, e.g. trstctl.com/trstctl/internal/agentid/delegation/store).
...
// O(1). searchRoots limits the walk (e.g. internal/agentid, cmd, internal).
...
var defaultSearchRoots = []string{"internal/agentid", "cmd", "internal"}
