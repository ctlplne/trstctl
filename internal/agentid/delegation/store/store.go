...
// mirrors internal/agentid/delegation.Record's persisted shape: the record digest (chain
...
// (AGID-claim-20). The reader lives in internal/agentid/revoke (NOT the signer-linked delegation
...
// read the CONTROL-PLANE directive-backed revocation reader (internal/agentid/revoke
