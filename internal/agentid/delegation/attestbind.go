...
// sub-package internal/agentid/delegation/brokerstore, which the signer never imports. Here we
...
// a replay. The production recorder (internal/agentid/delegation/brokerstore.Recorder) satisfies
