...
type PreconditionsBody struct {
	...
	// Envelope carries the encoded task envelope (internal/agentid/taskenv) the chain head
	...
	// ReachabilityVerdict carries the encoded signed reachability verdict (internal/agentid/reach)
