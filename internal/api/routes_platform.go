...
func (a *API) platformRoutes() []route {
	return []route{
		...
		{method: "GET", path: "/api/v1/posture/adcs/drift", opID: "getADCSTemplateDrift", summary: "List immutable semantic AD CS template drift history", handler: a.getADCSDrift, resSchema: "ADCSDriftHistory", successCode: "200", perm: authz.DiscoveryRead},
