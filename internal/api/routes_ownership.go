...
func (a *API) issuanceRequestRoutes() []route {
	...
	return []route{
		...
		{method: "PUT", path: "/api/v1/issuance-requests/intake-schedule", opID: "putTicketIntakeSchedule", summary: "Configure ITSM ticket intake: tickets become issuance requests, idempotently by ticket reference", handler: a.putTicketIntakeSchedule, reqSchema: "TicketIntakeInput", resSchema: "TicketIntakeSchedule", successCode: "200", mutation: true, perm: authz.CertsWrite},
		{method: "GET", path: "/api/v1/issuance-requests/intake-schedule", opID: "getTicketIntakeSchedule", summary: "The configured ticket intake with its last outcome", handler: a.getTicketIntakeSchedule, resSchema: "TicketIntakeSchedule", successCode: "200", perm: authz.CertsRead},
