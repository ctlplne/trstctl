...
func (a *API) routes() []route {
	...
	routes := []route{
		...
		}, resSchema: "BrokerAgentIdentityHistoryList", perm: authz.CertsRead},
		{method: "GET", path: "/api/v1/broker/agent-identities/{id}", opID: "getBrokerAgentIdentity", summary: "Read one broker certificate's original issuance facts and shared lifecycle state", handler: a.getBrokerAgentIdentity, pathParams: idPath, resSchema: "BrokerAgentIdentityHistory", perm: authz.CertsRead},
