...
// TestConformance_ChainVector: the published vector verifies with internal/rpverify AND with
...
func TestConformance_ChainVector(t *testing.T) {
	...
	// internal/rpverify accepts the vector.
...
// signatures over the canonical commitment. Agreement with internal/rpverify on every vector
...
// differential verifier disagree with internal/rpverify on a published vector, rather than
