...
// to it (internal/rpverify). All crypto routes through the core internal/crypto AN-3
// boundary.
//
...
// that is internal/rpverify.VerifyRecovery): the successor possession proof over the
