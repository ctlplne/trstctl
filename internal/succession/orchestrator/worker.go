...
// "succeed identity X" request to (internal/succession/api). The SuccessionRequestWorker
// consumes it.
...
// requestPayload mirrors the internal/succession/api enqueued request (RequestID plus the
