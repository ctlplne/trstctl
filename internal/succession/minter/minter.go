...
// refuses the mint. internal/succession/attest.Gate implements it.
...
// keygen (PCAS-claims-24, 40, PCAS-21). internal/succession/policy.ProvenanceVerifier implements
// it.
...
// commitment. internal/succession/delegation.MinterConstraint implements it.
...
// signer-attachment wrapper (internal/succession/signerwiring) uses it to bind the
...
// enforces single-use. The RP mirror (internal/rpverify) verifies the same token.
