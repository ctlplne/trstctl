...
func TestValidateExternalCAsFailsClosed(t *testing.T) {
	tests := []struct {
		...
		{"adcs-basic-over-loopback-http", ExternalCAConfig{ID: "a", Type: "adcs", Name: "a", Endpoint: "http://127.0.0.1:8080", CAConfig: `HOST\CA`, Template: "WebServer", Username: "operator", PasswordRef: "file:/safe/key", Network: ExternalCANetworkConfig{AllowInsecureHTTP: true}}, "password_ref requires an https endpoint"}, // #nosec G101 -- fabricated fixture credential/identifier; the test needs the shape, no value is real (CWE-798)
