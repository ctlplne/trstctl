...
func TestProdCaller_ReachableFromBinaryMain(t *testing.T) {
	...
	t.Fatalf("VDEC-INT-CALL STRONG CHECK FAILED: %d ee/decommission constructor(s) are not RTA-reachable from an in-scope binary main built without -tags trstctl_core:\n  - %s",
