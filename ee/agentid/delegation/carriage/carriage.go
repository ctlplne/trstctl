...
//
// Decoupling: this package deliberately does NOT import ee/agentid/delegation (the gate,
// which pulls the store/database and the signer wiring) nor ee/agentid/agentstack (which
...
// field framing of ee/agentid/delegation.BindingMaterial.CanonicalBytes (same field tags,
...
// framed IDENTICALLY to ee/agentid/delegation.BindingMaterial.CanonicalBytes (same
...
// ---- deterministic framing helpers (mirror ee/agentid/delegation) ----
