...
func openProviderStore(t *testing.T) *corestore.Store {
	...
	if _, err := s.SystemPool().Exec(ctx,
		`TRUNCATE provider_tenants, provider_breakglass_grants, provider_authority_projection_receipts, certificates, certificate_metadata_watermarks RESTART IDENTITY CASCADE`); err != nil {
