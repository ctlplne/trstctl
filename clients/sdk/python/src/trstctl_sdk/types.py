...
DRDrill = TypedDict(
    'DRDrill',
    {
        ...
        'signer_key_id': str,
        'store_healthy': bool,
        'verification_jwks': dict[str, Any],
    },
    total=False,
)
...
EndpointBindingPreview = TypedDict(
    'EndpointBindingPreview',
    {
        ...
        'ready': bool,
        'recovery_steps': list[str],
        'replaced_identity': dict[str, Any],
        'replaced_identity_version': int,
        'request_fingerprint': str,
        'target': dict[str, Any],
        'verification_steps': list[str],
    },
...
FleetReissuanceRun = TypedDict(
    'FleetReissuanceRun',
    {
        ...
        'candidate_trust_hosts': list[str],
        'candidate_trust_store_ids': list[str],
        'connector': str,
        ...
        'evidence_bundle': str,
        'evidence_bundle_format': str,
        'exact_trust_hosts': list[str],
        'exact_trust_store_ids': list[str],
        'failed_targets': list[str],
