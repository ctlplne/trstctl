(module
  ...
  (data (i32.const 0) "/var/lib/trstctl/plugins/out/issued.pemissued")
  ...
  ;; issue() writes the issued material. The write only succeeds if the grant covers the
  ...
  (func (export "issue") (result i32)
    i32.const 0    ;; path_ptr
    i32.const 39   ;; path_len
    i32.const 39   ;; data_ptr
    i32.const 6    ;; data_len
    call $cap_write))
