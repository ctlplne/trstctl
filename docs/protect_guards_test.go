...
func TestSchemaCompatibilityStrengthGuardsStayRequired(t *testing.T) {
	...
	for _, file := range []struct {
		...
		{"../internal/store/snapshot.go", []string{"SnapshotFormatVersion = 8", "WHERE format_version = $1", "SELECT tenant_id, payload FROM read_model_snapshots"}},
	} {
