...
Read it as a map of the issuance boundary. A requester-supplied CSR or public key
does not send its private key to the control plane. That observation cannot prove
where the key was originally generated or whether a previous operation handled it.
**Generated by the control plane** means this issuance did handle it, and says so.
