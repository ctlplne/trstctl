...
| `internal/cli/cli_test.go:2227` | test executes a fixed local tool or fixture it built itself (CWE-78) |
...
| `internal/cli/cli_test.go:2257` | fixture file in a test tempdir; the mode is part of the fixture (CWE-276) |
