...
| `internal/config/config.go:2191` | identifier/constant matching the secret-name heuristic; no credential value present (CWE-798) |
| `internal/config/config.go:2869` | identifier/constant matching the secret-name heuristic; no credential value present (CWE-798) |
...
| `internal/projections/discovery_declaration_convergence_test.go:389` | migration 0199 constrains the sequence to non-negative bigint values |
...
| `internal/server/server.go:2177` | served CA certificate directory; the PEM is public material (CWE-276) |
...
| `internal/server/server.go:2104` | operator-configured local file path from deployment config (CWE-22) |
| `internal/server/server.go:2181` | same operator-configured directory as the target certificate (CWE-22) |
...
| `internal/server/server.go:2187` | served CA certificate PEM is public material (CWE-276) |
