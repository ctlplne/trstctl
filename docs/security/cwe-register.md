...
| `internal/server/server.go:2147` | served CA certificate directory; the PEM is public material (CWE-276) |
...
| `internal/server/server.go:2157` | served CA certificate PEM is public material (CWE-276) |
