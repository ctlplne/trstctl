...
| `deploy/docker/dist_test.go:346` | names are non-secret evaluation OIDC configuration keys (CWE-798) |
...
| `internal/config/config.go:2863` | identifier/constant matching the secret-name heuristic; no credential value present (CWE-798) |
...
| `docs/docs_test.go:2537` | test walks the repo's own checkout; no hostile symlink exposure (CWE-367) |
...
| `deploy/docker/dist_test.go:652` | test executes a fixed local tool or fixture it built itself (CWE-78) |
| `deploy/docker/dist_test.go:755` | test executes a fixed local tool or fixture it built itself (CWE-78) |
| `deploy/docker/dist_test.go:1051` | test executes a fixed local tool or fixture it built itself (CWE-78) |
| `deploy/docker/dist_test.go:1116` | test executes a fixed local tool or fixture it built itself (CWE-78) |
...
| `internal/cli/cli_test.go:1800` | test executes a fixed local tool or fixture it built itself (CWE-78) |
...
| `deploy/docker/dist_test.go:995` | npm fixture tree in t.TempDir; mirrors a real package layout, nothing secret (CWE-276) |
...
### G304 — CWE-22 Path traversal (file inclusion via variable) (360 sites)
...
| `deploy/docker/dist_test.go:1067` | test reads its own fixture/tempdir path (CWE-22) |
...
| `internal/cli/cli_test.go:1379` | test reads its own fixture/tempdir path (CWE-22) |
...
| `internal/server/run.go:1094` | operator-configured local file path from deployment config (CWE-22) |
| `internal/server/run.go:1485` | operator-configured local file path from deployment config (CWE-22) |
...
| `deploy/docker/dist_test.go:998` | non-secret npm fixture manifest in t.TempDir (CWE-276) |
| `deploy/docker/dist_test.go:1001` | fixture file in a test tempdir; the mode is part of the fixture (CWE-276) |
| `deploy/docker/dist_test.go:1007` | fake npm shim in a test tempdir must be executable (CWE-276) |
...
| `internal/cli/cli_test.go:1830` | fixture file in a test tempdir; the mode is part of the fixture (CWE-276) |
...
| `internal/server/ssh_journey_served_test.go:196` | fixture file in a test tempdir; the mode is part of the fixture (CWE-276) |
