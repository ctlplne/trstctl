...
| `internal/cli/cli_test.go:2191` | test executes a fixed local tool or fixture it built itself (CWE-78) |
...
| `internal/cli/cli_test.go:2221` | fixture file in a test tempdir; the mode is part of the fixture (CWE-276) |
