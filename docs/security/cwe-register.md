...
| Location | Reason |
|---|---|
| `cmd/trstctl-agent/main.go:298` | 0700 on a directory: the execute bit is required to traverse it (CWE-276) |
...
| `cmd/trstctl-agent/main.go:355` | reconnect jitter, not a security decision (CWE-338) |
