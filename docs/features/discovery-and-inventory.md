...
Manager, GCP Secret Manager, Azure Key Vault, and HashiCorp Vault KV for certificate
material stored as secrets. The providers read only secret metadata plus the current value long
