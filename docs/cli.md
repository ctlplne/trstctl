...
| `identities`                      | Identity lifecycle: create, list, review an exact transition plan, execute it, approve dual-control actions, or bulk-revoke (`create` · `list` · `get` · `issuance-result` · `issuance-retry` · `deployment-evidence` · `transition-preview` · `transition` · `approve` · `approve issue` · `approve rotate` · `approve revoke` · `bulk-revoke`)                                   |
