...
const servedInventory = {
  ...
  items: [
    ...
    },
    {
      ...
      source: "discovery_finding",
      display_name: "payments-workload",
      status: "unmanaged",
      metadata: {},
      created_at: "2026-06-28T12:00:00Z",
    },
