      ...
      items: [
        {
          ...
          certificate_id: "c1",
          certificate_subject: "CN=service.example.com",
          certificate_fingerprint: "fp1",
          certificate_serial: "01",
          issuer_subject: "CN=Root CA",
          status: "stale",
          detail_code: "next_update_passed",
          latency_ms: 12,
          signature_verified: true,
          next_update: "2026-08-11T00:00:00Z",
          probe_id: "probe-1",
          observed_by_agent_id: "agent-1",
          observed_by_agent_name: "corp-relay",
        ...
        },
        {
          target_key: "ocsp-key",
          protocol: "ocsp",
          endpoint: "https://ocsp.example.test",
          certificate_id: "c1",
          certificate_subject: "CN=service.example.com",
          certificate_fingerprint: "fp1",
          certificate_serial: "01",
          ...
          next_update: "2026-08-13T00:00:00Z",
          probe_id: "probe-1",
          observed_by_agent_id: "agent-1",
          observed_by_agent_name: "corp-relay",
