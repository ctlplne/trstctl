...
export const journeys: Journey[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "engines", titleKey: "journeys.sec.engines.title", bodyKey: "journeys.sec.engines.body", to: "/secrets?tab=engines" },
      { id: "share", titleKey: "journeys.sec.share.title", bodyKey: "journeys.sec.share.body", to: "/secrets?tab=sharing" },
      { id: "scan", titleKey: "journeys.sec.scan.title", bodyKey: "journeys.sec.scan.body", to: "/secrets?tab=scanning" },
      { id: "sync", titleKey: "journeys.sec.sync.title", bodyKey: "journeys.sec.sync.body", to: "/secrets?tab=sync" },
    ],
  },
  {
    id: "ssh-at-scale",
