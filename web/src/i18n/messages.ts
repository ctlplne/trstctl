...
const esESCatalog = {
  ...
  "journeys.mig.description": "Encuentre todo lo que emitió la CA antigua, fije sus reglas y traslade la emisión de forma deliberada.",
  ...
  "journeys.team.token.body": "Un token con ámbito de tenant es la frontera del equipo: todo lo que toca permanece dentro del tenant.",
