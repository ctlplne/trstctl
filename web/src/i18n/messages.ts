...
export const messages = {
  ...
  "secrets.wif.createHeading": { defaultMessage: "Add AWS workload identity", description: "Create wizard heading." },
  "secrets.wif.created": { defaultMessage: "AWS workload identity source created.", description: "Create success notice." },
  "secrets.wif.delete": { defaultMessage: "Delete", description: "Delete workload-identity source action." },
  "secrets.wif.deleted": { defaultMessage: "AWS workload identity source deleted.", description: "Delete success notice." },
  "secrets.wif.deleting": { defaultMessage: "Deleting…", description: "Delete progress label." },
  "secrets.wif.description": {
    defaultMessage:
      "Bind an OIDC workload proof to one AWS sync target. trstctl exchanges it for a short-lived credential only while the bounded outbox worker delivers a secret.",
  ...
  "secrets.wif.editHeading": { defaultMessage: "Edit AWS workload identity", description: "Edit wizard heading." },
  "secrets.wif.empty": { defaultMessage: "No workload identities configured", description: "Empty list heading." },
  "secrets.wif.emptyBody": {
    defaultMessage: "Static AWS credentials remain unchanged until an operator explicitly adds a source here.",
  ...
  "secrets.wif.heading": { defaultMessage: "AWS workload identity federation", description: "Panel heading." },
  "secrets.wif.listLabel": { defaultMessage: "AWS workload identity sources", description: "Accessible list label." },
  ...
  "secrets.wif.selectTarget": { defaultMessage: "Select an AWS target", description: "AWS target selector placeholder." },
  ...
  "secrets.wif.target": { defaultMessage: "AWS sync target", description: "AWS secret-sync target field." },
  ...
  "secrets.wif.updated": { defaultMessage: "AWS workload identity source updated.", description: "Update success notice." },
