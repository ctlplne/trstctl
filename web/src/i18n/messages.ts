...
export const messages = {
  ...
  "source.created.d70b9e24bc": {
    ...
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Connectors.tsx, src/pages/Notifications.tsx, src/pages/Platform.tsx, src/pages/Secrets.tsx.",
  },
  ...
  "source.dismiss.48845bff33": {
    defaultMessage: "Dismiss",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Agents.tsx, src/pages/CAHierarchy.tsx, src/pages/Operations.tsx, src/pages/Platform.tsx, src/pages/Posture.tsx, src/pages/secrets/SecretsPageParts.tsx.",
  },
  ...
  "source.kind.f5387f9bb6": {
    defaultMessage: "Kind",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/CAHierarchy.tsx, src/pages/Connectors.tsx, src/pages/Discovery.tsx, src/pages/Graph.tsx, src/pages/Identities.tsx.",
  },
  ...
  "source.method.52a0f9b65b": {
    defaultMessage: "Method",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Platform.tsx, src/pages/Secrets.tsx, src/pages/Workloads.tsx, src/pages/secrets/SecretsPageParts.tsx.",
  },
  ...
  "source.name.dcd1d5223f": {
    defaultMessage: "Name",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/CAHierarchy.tsx, src/pages/Discovery.tsx, src/pages/Graph.tsx, src/pages/Identities.tsx, src/pages/Owners.tsx, src/pages/Secrets.tsx.",
  },
  ...
  "source.optional.ec91fdd925": {
    defaultMessage: "optional",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Certificates.tsx, src/pages/Incidents.tsx, src/pages/Platform.tsx, src/pages/Privacy.tsx.",
  },
  ...
  "source.reason.f81ab834de": {
    defaultMessage: "Reason",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Agents.tsx, src/pages/Connectors.tsx, src/pages/Identities.tsx, src/pages/Operations.tsx, src/pages/Platform.tsx, src/pages/Privacy.tsx, src/pages/SSHTrust.tsx.",
  },
  ...
  "source.refresh.0e91610117": {
    ...
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Agents.tsx, src/pages/CAHierarchy.tsx, src/pages/Discovery.tsx, src/pages/Notifications.tsx, src/pages/Operations.tsx, src/pages/Platform.tsx, src/pages/Secrets.tsx.",
  },
  ...
  "source.revoke.87e6d00bbf": {
    defaultMessage: "Revoke",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/CAHierarchy.tsx, src/pages/Certificates.tsx, src/pages/Identities.tsx, src/pages/Policy.tsx.",
  },
  ...
  "source.status.920e413c7d": {
    defaultMessage: "Status",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Agents.tsx, src/pages/Certificates.tsx, src/pages/Connectors.tsx, src/pages/Identities.tsx, src/pages/Incidents.tsx, src/pages/Platform.tsx, src/pages/Policy.tsx, src/pages/RequestCredential.tsx, src/pages/SSHTrust.tsx.",
  },
  ...
  "source.subject.6897128384": {
    defaultMessage: "Subject",
    description: "DA-14 sweep: migrated hardcoded copy from src/pages/Assistant.tsx, src/pages/Certificates.tsx, src/pages/Notifications.tsx, src/pages/Platform.tsx, src/pages/Privacy.tsx, src/pages/Secrets.tsx, src/pages/Workloads.tsx.",
  },
...
const esESCatalog = {
  ...
  "source.lifecycle.state.plus.projected.connector.a.efb351b308": "estado del ciclo de vida más evidencia proyectada de conector y rotación cuando un worker de outbox la ha producido.",
  ...
  "source.25.cited.records.8fedaba2c8": "25 cited records",
  ...
  "source.a.broker.turns.an.agent.identity.plus.poli.5efe1642ad": "A broker turns an agent identity plus policy into a short credential lease. Submit proof once, then render only returned identity metadata.",
  "source.a.fresh.trstctl.server.provisions.a.signer.a1ee587e50": "A fresh trstctl server provisions a signer-backed internal X.509 CA at boot. Confirm it before the first certificate is issued.",
  "source.a.password.shared.secret.or.opaque.credent.b98b0c5e45": "A password, shared secret, or opaque credential identity tracked separately from certificate inventory.",
  "source.a.safe.rollout.names.the.candidate.ca.targ.fdf82b1ab9": "A safe rollout names the candidate CA, target hosts, validation command, reload health command, rollback plan, and explicit confirmation copy before any host changes trust.",
  "source.a.service.job.agent.or.workload.identity.t.dcc4188b56": "A service, job, agent, or workload identity that can be issued short-lived credentials instead of storing static secrets.",
  "source.a.short.lived.ssh.host.or.user.certificate.17848c47a5": "A short-lived SSH host or user certificate identity controlled by the SSH CA and lifecycle state machine.",
  "source.a.standing.ssh.key.identity.that.should.be.6e4dc64176": "A standing SSH key identity that should be owned, rotated, and retired like any other non-human credential.",
  "source.a.tls.or.mtls.identity.whose.lifecycle.is.d720dfba65": "A TLS or mTLS identity whose lifecycle is backed by certificate issuance, revocation, and expiry evidence.",
  "source.aad.9adbaf62d8": "AAD",
  "source.access.test.failed.e280577658": "Access test failed",
  "source.access.test.passed.for.e4a15ad68a": "Access test passed for",
  "source.acknowledge.wildcard.blast.radius.868520eb71": "Acknowledge wildcard blast radius",
  "source.activate.an.existing.signer.backed.success.ba9399274b": "Activate an existing signer-backed successor while the predecessor issue URL remains valid for the overlap window.",
  "source.activate.ca.rotation.a7d096d68f": "Activate CA rotation",
  "source.active.ceremony.282727eb03": "Active ceremony",
  "source.actor.449995c4fe": "Actor",
  "source.add.a.local.authority.or.upstream.ca.befor.ef39bb7995": "Add a local authority or upstream CA before certificates can be issued from constrained profiles.",
  "source.add.a.network.cloud.ct.log.nhi.oauth.servi.1798feb274": "Add a network, cloud, CT log, NHI, OAuth, service-account, behavior, compromise, or agent source before discovery runs can be queued.",
  "source.add.certificate.6fa2cfd67c": "Add certificate",
  "source.add.row.1868a8dd78": "Add row",
  "source.adjust.filters.refresh.the.queue.or.move.t.4a4fa7f45b": "Adjust filters, refresh the queue, or move to the approval and certificate worklists that create operations.",
  "source.advanced.json.import.c72cfacdf6": "Advanced JSON import",
  "source.advanced.query.fd7300e32b": "Advanced query",
  "source.advanced.runtime.diagnostics.c1b601f9f3": "Advanced runtime diagnostics",
  "source.affected.19b6357dad": "affected",
  "source.affected.identity.031ba2eb6f": "Affected identity",
  "source.affects.e3e4b7e9f8": "affects",
  "source.agent.11b39c9377": "Agent",
  "source.agent.fleet.ac46d1b700": "Agent fleet",
  "source.agent.id.510bce732d": "Agent ID",
  "source.agent.identity.698c87920a": "Agent identity",
  "source.agent.profile.heartbeat.and.version.detail.fbb4a88e48": "Agent profile, heartbeat, and version details.",
  "source.agents.279b44d2ab": "Agentes",
  "source.ai.agent.broker.identities.6ec86399a3": "AI agent broker identities",
  "source.ai.agent.nhi.broker.3c610aca90": "AI-agent / NHI broker",
  "source.ai.runtime.boundary.0126aa890a": "AI runtime boundary",
  "source.ai.runtime.status.unavailable.b36957005d": "AI runtime status unavailable",
  "source.alert.routing.is.managed.from.notification.f26eb33c8e": "Alert routing is managed from Notifications",
  "source.algorithm.d704d8af25": "Algorithm",
  "source.algorithm.mix.a5ab80b898": "Algorithm mix",
  "source.all.a52ace420f": "Todas",
  "source.all.environments.f19ac5a6af": "All environments",
  "source.all.issuers.ab00116bbe": "All issuers",
  "source.all.kinds.ddd0c2108e": "All kinds",
  "source.all.profiles.18f6aff3fe": "All profiles",
  ...
  "source.allowed.dns.suffixes.c2747c3707": "Allowed DNS suffixes",
  "source.an.api.token.or.service.key.identity.where.8f7b48a2e6": "An API token or service key identity where ownership, age, and retirement matter more than a certificate chain.",
  "source.analyze.selected.node.9d2c6d8829": "Analyze selected node",
  "source.and.cannot.remediate.or.mutate.credentials.564b159ab9": "and cannot remediate or mutate credentials. Model egress and redaction posture are read from the runtime status above.",
  "source.any.privilege.9e7167aefa": "Any privilege",
  "source.api.key.identity.bc78809131": "API key identity",
  "source.api.token.metadata.d3e4dba811": "API token metadata",
  "source.app.db.password.917cb98f9d": "app/db/password",
  "source.applies.to.6687458bee": "Applies to",
  "source.apply.filters.d80ab19b7e": "Apply filters",
  "source.apply.risk.filters.8d00abcce9": "Apply risk filters",
  "source.approval.147fb813a2": "Approval",
  "source.approvals.2bfc347157": "Aprobaciones",
  "source.approvals.unavailable.8071a7e2c8": "Approvals unavailable",
  "source.approve.6007acbe30": "Aprobar",
  "source.approvers.99f86511e2": "Approvers:",
  "source.artifact.digest.f7f37af3fe": "Artifact digest",
  "source.artifact.type.c4984fa09a": "Artifact type",
  "source.assistant.391e405152": "Asistente",
  "source.assistant.answer.ba33c88efb": "Assistant answer",
  "source.assistant.workflow.8962351a8a": "Assistant workflow",
  "source.attempts.06e70139fc": "Attempts",
  "source.attestation.gated.ssh.user.certs.d49d24e892": "Attestation-gated SSH user certs",
  "source.attestation.method.1f0610be7c": "Metodo de atestacion",
  "source.attestation.payload.base64.11bfdba122": "Attestation payload base64",
  "source.attestors.2e3ad3c00b": "Attestors",
  "source.attributes.4b0ed88f7d": "Attributes",
  "source.audit.and.key.boundary.1ff2138216": "Audit and key boundary",
  "source.audit.bb6aea2873": "Auditoría",
  "source.audit.evidence.74dbcfd2a3": "Audit evidence",
  "source.audit.ids.e1133f2a79": "Audit IDs",
  "source.audit.log.e4d36f9a4e": "Audit log",
  "source.audit.stream.22c7391e55": "audit stream",
  "source.audit.trail.c1ada08ce1": "Audit trail",
  "source.auth.and.profile.gate.220561196c": "Auth and profile gate",
  "source.auth.session.0e46f553a4": "Auth session",
  "source.authenticate.with.your.organization.s.iden.c19821f6a0": "Authenticate with your organization's identity provider to manage credentials.",
  "source.authority.key.60329d7d7b": "Authority key",
  "source.authority.key.cfdd3eeb4b": "authority key",
  "source.available.ca.integrations.and.local.signin.a7967de86e": "Available CA integrations and local signing authority templates.",
  "source.awaiting.approval.ae25c9b1d3": "Awaiting approval",
  "source.aws.iam.c37b8156ed": "AWS IAM",
  "source.aws.kms.azure.key.vault.hsm.gcp.cloud.kms.957ee3c57b": "AWS KMS, Azure Key Vault HSM, GCP Cloud KMS, and PKCS#11 HSM keys stay inside their provider. This panel shows public metadata and drives custody actions by key id.",
  "source.background.jobs.perform.access.token.revoc.5f46484521": "Background jobs perform access-token revocation and audit projection work while write promotion remains an operator-controlled runbook.",
  "source.batch.size.8cfe32a041": "Batch size",
  "source.batches.467629e63d": "batches",
  "source.batches.56a8df948f": "Batches",
  "source.before.this.destructive.action.b4c45f22e1": "before this destructive action.",
  ...
  "source.billable.unit.2373d1d5f8": "Billable unit",
  "source.bind.56b9b63d28": "Bind",
  "source.bind.and.enroll.5cb885780a": "Bind and enroll",
  "source.blast.radius.8638fdf109": "Radio de impacto",
  "source.blast.radius.impact.42dfddadef": "Blast-radius impact",
  "source.blast.radius.paths.and.by.kind.summary.d6a5526110": "Blast-radius paths and by-kind summary",
  "source.blast.radius.preview.unavailable.00a241de01": "Blast-radius preview unavailable",
  "source.blast.radius.snapshot.c447c874b9": "Blast-radius snapshot",
  "source.blast.radius.unavailable.8114fa5306": "Blast radius unavailable",
  "source.bootstrap.token.2996dc8b78": "Bootstrap token",
  "source.break.glass.help.9f8fde42af": "Break-glass help",
  "source.broker.history.isn.t.in.the.console.yet.7fc4ef9d7d": "Broker history isn't in the console yet",
  "source.broker.identity.failed.90cf96d503": "Broker identity failed",
  "source.broker.method.86e0708911": "Broker method",
  "source.broker.proof.payload.base64.caf8633720": "Broker proof payload (base64)",
  "source.broker.public.key.a2341b0f4e": "Broker public key",
  "source.broker.scopes.60ad7540e2": "Broker scopes",
  "source.broker.ttl.seconds.7112a719ce": "Broker TTL seconds",
  "source.browser.transport.is.evaluated.at.runtime.94214a825a": "Browser transport is evaluated at runtime.",
  "source.bulk.revoke.selected.53f4891ce3": "Bulk revoke selected",
  "source.bundle.bytes.842399751d": "Bundle bytes",
  "source.business.purpose.286d11d720": "Business purpose",
  "source.by.key.type.7228596a06": "by key type",
  "source.ca.chain.pem.add189510a": "CA chain PEM",
  "source.ca.hierarchy.73e4cbcaf4": "Jerarquía de CA",
  "source.ca.key.ceremony.244faa4ab3": "CA key ceremony",
  "source.ca.re.key.failed.c94515c43b": "CA re-key failed",
  "source.ca.renewal.and.re.key.fb27d9e180": "CA renewal and re-key",
  "source.ca.rotation.27b00eaa0b": "CA rotation",
  "source.ca.rotation.failed.e781fb6f5f": "CA rotation failed",
  "source.caa.084696b5b2": "CAA",
  "source.cacerts.d757429cef": "cacerts",
  "source.campaign.268286d2ef": "Campaign",
  "source.campaigns.certify.non.human.identity.acces.5d99189fbe": "Campaigns certify non-human identity access from identifiers and evidence references. The console never accepts credential values here.",
  "source.cancel.19766ed6cc": "Cancel",
  "source.cancel.is.not.available.for.this.operation.0210a0d77e": "Cancel is not available for this operation yet. Use the owning workflow to stop or roll it back.",
  "source.candidate.ca.fingerprint.78e53d126d": "Candidate CA fingerprint",
  ...
  "source.cbom.and.cryptographic.observability.11b90cf944": "CBOM and cryptographic observability",
  "source.cbom.asset.inventory.2ba70c3036": "CBOM asset inventory",
  "source.cbom.b79109c7e7": "CBOM",
  "source.ceremony.action.failed.974d5f2180": "Ceremony action failed",
  "source.certbot.2fdd3b0f47": "certbot",
  "source.certificate.2a93a8a442": "Certificado",
  "source.certificate.detail.8537d4ad03": "Certificate detail",
  "source.certificate.details.fccff74faf": "Certificate details",
  "source.certificate.pem.85627425ca": "PEM del certificado",
  "source.certificate.transparency.findings.55891f79b6": "Certificate Transparency findings",
  "source.certificate.transparency.monitoring.a0ad3241c4": "Certificate Transparency monitoring",
  "source.certificates.16f637921e": "Certificados",
  "source.certificates.for.143f183f89": "Certificates for",
  ...
  "source.change.request.6946efe81c": "Change request",
  "source.check.for.agent.1649b814df": "Check for agent",
  "source.checked.0efd92a335": "Checked",
  "source.checking.protocol.responders.b300fe1dfa": "Checking protocol responders.",
  "source.ci.deploy.preview.d2c6100222": "ci/deploy-preview",
  "source.ciphertext.47955e6673": "Ciphertext",
  "source.cited.evidence.ca23c85308": "Cited evidence",
  "source.claims.1c85c12229": "Claims",
  "source.clear.filters.7179ea0035": "Clear filters",
  "source.cli.injector.1f36b02aea": "CLI injector",
  "source.client.setup.4ba2b51d20": "Client setup",
  "source.close.help.88f2b69280": "Close help",
  "source.close.issuer.form.b40f6c2037": "Close issuer form",
  "source.cluster.service.path.f9947d11c2": "cluster/service/path",
  "source.code.and.ci.secret.scanning.bridge.27c18d763b": "Code and CI secret scanning bridge",
  "source.code.signing.4871711be4": "Firma de código",
  "source.common.name.2d129020eb": "Nombre común",
  "source.compare.with.version.96965654cd": "Compare with version",
  "source.compared.17c858fc6d": "Compared",
  "source.comparing.selected.v.4b46e29d45": "Comparing selected v",
  "source.complete.143b270a32": "Complete",
  "source.complete.setup.fe3da4e70b": "Complete setup",
  "source.completed.22a970d2e5": "Completed",
  "source.compromise.of.988dd256bd": "Compromise of",
  "source.compromised.05ab8ef2cf": "Compromised",
  "source.compromised.issuer.18ef83eabb": "Compromised issuer",
  "source.compromising.6baa2b0ea9": "Compromising",
  "source.compute.hmac.4809a2f350": "Compute HMAC",
  "source.config.json.eaa2c019f1": "Config JSON",
  "source.configure.6defafa2ca": "Configure",
  "source.confirm.bulk.revoke.d613327838": "Confirm bulk revoke",
  "source.confirm.high.blast.radius.ssh.trust.rollou.31dcb6c476": "Confirm high-blast-radius SSH trust rollout evidence",
  "source.confirm.the.signer.backed.internal.ca.or.c.b20abca15c": "Confirm the signer-backed internal CA or connect an upstream authority later.",
  "source.connect.an.issuer.c155ecb073": "Connect an issuer",
  "source.connect.first.issuer.ba893ce98c": "Connect first issuer",
  "source.connection.639a40e82b": "Connection",
  "source.connection.failed.1c43266b45": "connection failed",
  "source.connection.passed.49369abdb8": "connection passed",
  "source.connection.pending.31378595b4": "connection pending",
  "source.connector.8f0d706fff": "Connector",
  "source.connector.registry.714802c316": "Connector registry",
  "source.connector.targets.fb63eee9b5": "Connector targets",
  "source.connector.workflow.failed.9b83125cd7": "Connector workflow failed",
  "source.contract.boundary.67a4070e64": "Contract boundary",
  "source.control.32d7e82082": "Control",
  "source.controls.1e2135d1b5": "controls",
  "source.copied.command.without.token.material.6c656e4f88": "Copied command without token material.",
  "source.copied.from.this.reveal.panel.0707425cf6": "Copied from this reveal panel.",
  "source.copied.once.from.memory.ffb61f0314": "Copied once from memory.",
  "source.copy.command.9a01feecae": "Copiar comando",
  "source.copy.e21f935f11": "Copiar",
  "source.copy.once.acfaa3d4d6": "Copy once",
  "source.copy.or.download.now.the.serial.certificat.3760ad67db": "Copy or download now. The serial, certificate, and private key are cleared when dismissed.",
  "source.copy.this.generated.credential.now.renew.a.811264cbb9": "Copy this generated credential now. Renew and revoke actions keep only lease metadata.",
  "source.correlation.id.c267c186e8": "ID de correlación",
  "source.could.not.ingest.certificate.f876a7f9c6": "Could not ingest certificate",
  "source.could.not.load.agents.1d510cf246": "Could not load agents",
  "source.could.not.load.certificate.details.7999752b96": "Could not load certificate details",
  "source.could.not.load.certificates.21ae8e6e19": "Could not load certificates",
  "source.could.not.load.owners.f32406fb21": "Could not load owners",
  "source.could.not.load.tools.2e7b9eae6f": "Could not load tools:",
  "source.could.not.mint.enrollment.token.7b0b6374e9": "Could not mint enrollment token",
  "source.could.not.sign.artifact.67ae96a355": "Could not sign artifact",
  "source.coverage.523487a5de": "Coverage",
  "source.create.a.certificate.profile.before.issuin.cdb32f2c2e": "Create a certificate profile before issuing from a constrained template.",
  "source.create.a.profile.6d7beeefb5": "Create a profile",
  "source.create.a.signer.backed.successor.before.ac.c0163adb05": "Create a signer-backed successor before activating rotation.",
  "source.create.connector.target.bb8ec59505": "Create connector target",
  "source.create.discovery.source.0371fe8d52": "Create discovery source",
  "source.create.endpoint.binding.dd5b21a786": "Create endpoint binding",
  "source.create.first.source.4d63a7434c": "Create first source",
  "source.create.issuer.83b848cf15": "Create issuer",
  "source.create.one.time.share.fd95a197d6": "Create one-time share",
  "source.create.or.activate.a.certificate.profile.b.246493dc15": "Create or activate a certificate profile before self-service requests can be accepted.",
  "source.create.or.import.a.signer.backed.authority.938d8e0658": "Create or import a signer-backed authority before re-key.",
  "source.create.profile.61d30d997d": "Create profile",
  "source.create.schedule.5b08f3c719": "Crear programación",
  "source.create.secret.b72a982613": "Create secret",
  "source.create.share.bb7a8c7b6e": "Create share",
  "source.create.source.020457fb23": "Crear origen",
  "source.create.source.to.run.8ef21d8f2a": "Create source to run",
  "source.create.target.00cf884cbc": "Create target",
  "source.create.the.first.workload.identity.and.iss.e199fc813f": "Create the first workload identity and issue it with an operator credential.",
  "source.created.d70b9e24bc": "Created",
  "source.credential.compromise.execution.3cfb067780": "Credential compromise execution",
  "source.credential.detail.7c1b378919": "Credential detail",
  "source.credential.graph.edges.3f0fea5e6d": "Credential graph edges",
  "source.credential.graph.nodes.4c10852dfc": "Credential graph nodes",
  "source.credential.name.911c43d9f0": "Credential name",
  "source.credentials.issued.per.month.11bd254ee7": "credentials issued per month",
  "source.crypto.agility.means.the.system.can.see.we.6ff0a0d217": "Crypto-agility means the system can see weak algorithms, reject disallowed choices, and plan safe rotations without guessing from browser-only state.",
  "source.crypto.agility.readiness.7bc9bc7019": "Crypto-agility readiness",
  "source.cryptographic.bill.of.materials.an.invento.b2a4a4fd81": "Cryptographic Bill of Materials: an inventory of algorithms, key sizes, protocols, and crypto posture.",
  "source.csrf.cookie.04ee351267": "CSRF cookie",
  "source.csv.upload.1a9c1686fd": "CSV upload",
  "source.ct.anomalies.and.drift.findings.can.be.rou.360679ac1d": "CT anomalies and drift findings can be routed through saved notification policies. Channel credentials stay in operator-managed configuration.",
  "source.ct.log.checkpoints.4f19929a7b": "CT log checkpoints",
  "source.ct.log.urls.20c5c9807c": "CT log URLs",
  "source.ct.monitoring.watches.public.logs.for.cert.3163770746": "CT monitoring watches public logs for certificates your tenant did not request. The discovery worker polls configured logs, records tenant-scoped findings, and dispatches unexpected-issuance alerts through the notification outbox.",
  "source.current.filters.4e3b0ba1cb": "Current filters",
  "source.current.phase.44c03cecc0": "Current phase",
  "source.current.rotation.version.ede128c23f": "Current rotation version:",
  "source.current.session.subject.1f6510ea4d": "current session subject",
  "source.customer.bf3763383a": "Customer",
  "source.cypher.style.query.9e70f5d770": "Cypher-style query",
  "source.dashboard.67b6964686": "Panel",
  "source.data.cec3a9b89b": "Data",
  "source.data.residency.4ab08acdfa": "Data residency",
  "source.decision.640ae4baf9": "Decisión",
  "source.decrypted.plaintext.675dd9b983": "Decrypted plaintext",
  "source.default.algorithm.ecdsa.p256.e268f7deba": "Default algorithm: ECDSA-P256.",
  "source.default.request.trust.root.ca.2.approvals.246b100b12": "Default request: Trust Root CA, 2 approvals, ECDSA-P256.",
  "source.delete.dns.01.provider.config.d870732e81": "Delete DNS-01 provider config “",
  "source.delete.e2d0a54968": "Eliminar",
  "source.delete.failed.8727e2ba36": "Delete failed",
  "source.delete.scep.policy.1a5e5ddeb3": "Delete SCEP policy “",
  "source.delete.secret.1a48c8c830": "Delete secret",
  "source.deliverables.c7ec4b92c2": "Deliverables",
  "source.delivered.9061156573": "Delivered",
  "source.delivery.52bfe584a5": "Entrega",
  "source.delivery.and.rotation.evidence.1fc4ef65bb": "Delivery and rotation evidence",
  "source.delivery.evidence.failed.to.load.2625e33346": "Delivery evidence failed to load",
  "source.delivery.method.26b6ab1b68": "Delivery method",
  "source.delivery.mode.c9585346ea": "Delivery mode",
  "source.deploy.4c236daafb": "Deploy",
  "source.deploy.through.connector.47966b95ca": "Deploy through connector",
  "source.deployment.870a8ffd98": "Deployment",
  "source.deployment.connectors.6bdaa16cc0": "Conectores de despliegue",
  "source.deployment.location.5a9f62f9fc": "Deployment location",
  "source.deployment.model.48b995f6f0": "Deployment model",
  "source.deployment.target.5b274e18ab": "Deployment target",
  "source.destination.293d404a50": "Destino",
  "source.detail.fields.6c69673d46": "Detail fields",
  "source.developer.access.e62e23a3a2": "Developer access",
  "source.diff.version.b5aedae8c4": "Diff version",
  "source.discover.d4a33d5b78": "Discover",
  "source.discovery.80fc402133": "Descubrimiento",
  "source.discovery.findings.unavailable.8112281292": "Discovery findings unavailable",
  "source.discovery.run.f6dd5be06b": "Discovery run",
  "source.discovery.source.f533df1c0c": "Fuente de descubrimiento",
  "source.discovery.unavailable.839198b6dc": "Discovery unavailable",
  ...
  "source.download.signed.bundle.c6373a92cb": "Download signed bundle",
  "source.downstream.affected.node.0dfbe99d70": "downstream affected node",
  "source.downstream.node.35861aa3d8": "downstream node",
  "source.drift.detection.93e554780a": "Drift detection",
  "source.drift.detection.compares.what.trstctl.inte.95457304d6": "Drift detection compares what trstctl intended to deploy with what the worker can verify from a configured watched credential path. Deleted, replaced, relocated, and permission-changed credentials become tenant-scoped Discovery findings.",
  "source.drift.findings.cd56c69007": "Drift findings",
  "source.drift.remediation.unavailable.2da12cc33d": "Drift remediation unavailable",
  "source.drift.remediation.workflow.9456b591c4": "Drift remediation workflow",
  "source.drilldown.links.66ec8eb823": "Drilldown links",
  "source.dry.run.d5da154d9f": "Dry run",
  "source.dynamic.lease.operation.failed.115f5893e7": "Dynamic lease operation failed",
  "source.dynamic.secrets.70f2c5b95c": "Dynamic secrets",
  "source.e.g.change.approved.in.cab.1234.6a0cc1f9e3": "e.g. change approved in CAB-1234",
  "source.e.g.payments.api.b39781a2b3": "e.g. payments-api",
  "source.each.execution.or.playbook.run.is.a.projec.9af41ecb88": "Each execution or playbook run is a projected event-sourced evidence pack with revocation, delivery, rollback, and audit state.",
  "source.each.protocol.requires.an.enabled.flag.plu.a66867a87e": "Each protocol requires an enabled flag plus a tenant ID. Startup rejects an enabled protocol with no tenant binding, and issuance refuses requests when no issuing CA/profile can satisfy the protocol request.",
  "source.edge.prod.79b3e5ef21": "edge/prod",
  "source.edge.prod.payments.178b58c24e": "edge/prod/payments",
  "source.edge.types.396a236285": "Edge types",
  "source.edges.658b158af9": "Edges",
  "source.edit.464c4ffd01": "Editar",
  "source.edit.dns.01.provider.config.1daa884c33": "Edit DNS-01 provider config",
  "source.edit.scep.policy.5719a7d8ab": "Edit SCEP policy",
  "source.edition.feature.table.9690596a9d": "Edition feature table",
  "source.editions.c6a48dcca4": "Editions",
  "source.egress.66a3afae15": "Egress",
  "source.emergency.issuance.guard.5a3ad01167": "Emergency issuance guard",
  "source.emergency.issuance.requires.declaration.qu.24cf522826": "Emergency issuance requires declaration, quorum, offline issue evidence, verification, expiry, reconciliation, and cleanup.",
  "source.enabled.92c1cdfdf4": "Habilitada",
  "source.encrypted.result.or.ciphertext.to.decrypt.88441adfe9": "encrypted result or ciphertext to decrypt",
  "source.endpoint.host.4f0d916bb9": "Endpoint host",
  "source.engine.8e75ebbdb2": "Engine",
  "source.engine.native.store.d6b23ebfdb": "Engine: native store",
  "source.enroll.agent.8592144d44": "Enroll agent",
  "source.enroll.an.agent.43dbb20757": "Enroll an agent",
  "source.enrollment.protocol.surfaces.de695f7aa5": "Enrollment protocol surfaces",
  "source.enrollment.token.6c86be7863": "Enrollment token",
  "source.enterprise.sla.target.table.dfd20c29f8": "Enterprise SLA target table",
  "source.enterprise.support.b31b42b62d": "Enterprise support",
  "source.enterprise.support.tier.table.0b375fcc18": "Enterprise support tier table",
  "source.entitlement.0d8f0b2d3a": "Derecho",
  "source.environment.filter.3495eee74d": "Environment filter",
  "source.ephemeral.api.key.59757a0857": "Ephemeral API key",
  "source.ephemeral.api.key.issue.failed.b91df9889a": "Ephemeral API-key issue failed",
  "source.ephemeral.api.keys.6c8f7c6a2c": "Ephemeral API keys",
  "source.escalation.35615b8245": "Escalation",
  "source.etc.ssh.sshd.config.83ca950c7a": "/etc/ssh/sshd_config",
  "source.event.detail.097e77abc2": "Event detail",
  "source.event.source.60dbb37270": "Event source",
  "source.evidence.03867aea70": "Evidencia",
  "source.evidence.5da3c91b4d": "evidence:",
  "source.evidence.export.unavailable.9cb4129ff9": "Evidence export unavailable",
  "source.evidence.pack.dbd6e1203e": "evidence pack",
  "source.evidence.refs.edfa905c2f": "Refs. de evidencia",
  "source.evidence.surfaces.6acbb05a44": "Evidence surfaces",
  ...
  "source.exchange.a.machine.credential.for.a.scoped.db8919fe53": "Exchange a machine credential for a scoped workload session. The submitted credential is cleared after submit and never echoed.",
  "source.execution.a45cd4bd09": "Execution",
  "source.execution.evidence.81ad27c5fa": "Execution evidence",
  "source.expiration.timeline.d4a2b2aa1e": "Expiration timeline",
  ...
  "source.expiry.bands.cbfe64f7cb": "Expiry bands",
  "source.explanation.16ee4625bc": "Explanation",
  "source.explore.nodes.4171237dea": "Explore nodes",
  "source.explore.the.console.1f6607ee75": "Explore the console",
  "source.explorer.464ef011fa": "Explorer →",
  "source.export.evidence.caab91492e": "Export evidence",
  "source.export.query.rows.b38bb9ef0b": "Export query rows",
  "source.extend.seconds.ff4a8186f0": "Extend seconds",
  "source.fail.closed.startup.and.issuance.posture.661fcb680a": "Fail-closed startup and issuance posture",
  "source.failed.031a8f0f65": "Failed",
  "source.failed.checks.890e88faab": "Failed checks:",
  "source.failed.ff18811f27": ", failed",
  "source.failed.targets.4ffa850540": "Failed targets",
  "source.feature.3d377ae910": "Feature",
  "source.file.50009ce1da": "File",
  "source.findings.e171c2ff25": "Hallazgos",
  "source.findings.populate.after.discovery.observes.9d8596dcef": "Findings populate after discovery observes certificates, secrets, SSH trust, or drift.",
  "source.fingerprint.ba7af0b704": "Huella",
  "source.fips.posture.4051e94687": "FIPS posture",
  "source.fleet.evidence.exported.eecc6a3c77": "Fleet evidence exported",
  "source.fleet.re.issuance.fa35f7921e": "Fleet re-issuance",
  "source.fleet.reissuance.failed.734d656156": "Fleet reissuance failed",
  "source.fleet.reissuance.runs.c1afb05039": "Fleet reissuance runs",
  "source.fleet.run.recorded.ff2d7b78ff": "Fleet run recorded",
  "source.for.10c22bcf4c": "for",
  "source.format.2f343666aa": "Format",
  "source.fresh.ca.material.d1a53a627a": "Fresh CA material",
  "source.fresh.heartbeat.39d75ce503": "Fresh heartbeat",
  "source.from.2181976934": "From",
  "source.fulcio.issuer.6baae4cd90": "Fulcio issuer",
  "source.full.delivery.subject.ownership.and.routin.32d5733727": "· full delivery, subject, ownership, and routing state.",
  "source.generate.a.managed.key.to.inspect.its.publ.0756dcae94": "Generate a managed key to inspect its public metadata and lifecycle state.",
  "source.generate.managed.key.9ff7b150a0": "Generate managed key",
  ...
  "source.graph.blast.radius.c70f3638eb": "Graph blast radius",
  "source.graph.legend.f23f97006d": "Graph legend",
  "source.graph.node.8779202b33": "Graph node",
  "source.graph.query.e11ba75b6e": "Graph query",
  "source.graph.query.unavailable.18971b61f4": "Graph query unavailable",
  "source.graph.unavailable.ef2233a071": "Graph unavailable",
  "source.graph.workspace.9a09dc9bbf": "Graph workspace",
  "source.grounded.means.the.answer.cites.tenant.evi.0c488b912f": "Grounded means the answer cites tenant evidence returned by the API.",
  "source.grounded.query.2a3d813fd7": "Grounded query",
  "source.guided.builder.16111a6ae3": "Guided builder",
  "source.hash.a91069147f": "Hash",
  "source.hash.chain.status.f5491b14e9": "Hash-chain status",
  "source.health.command.5ad9864488": "Health command",
  "source.highest.risk.c56ed7dd58": "highest-risk",
  "source.hmac.and.signing.a21f893b5b": "HMAC and signing",
  "source.host.4a823118b9": "Host",
  "source.host.config.paths.8b2c6c7bdd": "Host config paths",
  "source.host.retirement.4f92fcc0ea": "Host retirement",
  "source.hosted.id.16f3dc88ea": "Hosted ID",
  "source.hosted.name.af1e0d31be": "Hosted name",
  ...
  "source.https.observed.50a13e2b41": "HTTPS observed",
  "source.id.3843971dcf": "ID",
  "source.idempotent.credential.request.94e8630aea": "Idempotent credential request",
  "source.identities.8d4d8fef65": "Identidades",
  "source.identity.999f23fcd7": "Identidad",
  "source.identity.action.failed.5e3283fa66": "Identity action failed",
  "source.identity.detail.f34a3c7053": "Identity detail",
  "source.identity.dns.name.c79a6b3b97": "Identity DNS name",
  "source.identity.id.2f8124d39c": "Identity ID",
  "source.identity.id.ff02cbf157": "identity-id",
  "source.identity.issued.08c478fa05": "identity.issued",
  "source.identity.method.324ef3acce": "Identity method",
  "source.identity.payload.7cafae50c5": "Identity payload",
  "source.identity.uuid.ae37807bc4": "identity uuid",
  "source.impact.d1f23f0d13": "Impact",
  "source.incident.36a606d488": "Incident",
  "source.incident.evidence.unavailable.248e285efe": "Incident evidence unavailable",
  "source.incident.execution.evidence.ed369964a3": "Incident execution evidence",
  "source.incident.execution.failed.70db66b277": "Incident execution failed",
  "source.incident.execution.issues.and.deploys.a.re.c00d70d3f5": "Incident execution issues and deploys a replacement identity before revoking the compromised identity.",
  "source.incident.execution.recorded.2ea0b1ce57": "Incident execution recorded",
  "source.incident.response.help.7245c4b82c": "Incident response help",
  "source.incidents.bfe8689315": "Incidentes",
  "source.ingest.certificate.6c25a63cd4": "Ingest certificate",
  "source.initial.sla.ee9124e35d": "Initial SLA",
  "source.install.command.1ae9754205": "Install command",
  "source.internal.2ea1842b44": "Internal",
  "source.internet.tls.f6752ebc7d": "internet, tls",
  "source.interval.seconds.5f0f5b832a": "Interval seconds",
  "source.investigate.e264109347": "Investigate",
  "source.is.ready.17f5581890": "is ready.",
  "source.issuance.rate.91f4b7ff0d": "Issuance rate",
  "source.issuance.trend.b53089f166": "Issuance trend",
  "source.issue.48dc76dfa2": "Issue",
  "source.issue.a.lease.scoped.credential.from.a.con.9d8b9440ef": "Issue a lease-scoped credential from a configured provider, renew its expiry when needed, or revoke it immediately. Generated credentials are shown once and then cleared from the page.",
  "source.issue.a.short.lived.certificate.bundle.and.68b22cee4d": "Issue a short-lived certificate bundle and reveal the private key only in the explicit result panel.",
  "source.issue.api.key.3cdf19cbb9": "Issue API key",
  "source.issue.attested.ssh.cert.fba31f1beb": "Issue attested SSH cert",
  "source.issue.attested.ssh.user.certificate.f7e0f6ef66": "Issue attested SSH user certificate",
  "source.issue.broker.identity.a95ac0066b": "Issue broker identity",
  "source.issue.certificate.ff84c7ec37": "Issue certificate",
  "source.issue.deploy.or.renew.an.identity.to.produ.722d26ac6c": "Issue, deploy, or renew an identity to produce outbox-backed evidence.",
  "source.issue.dynamic.lease.7f0d0fe084": "Emitir lease dinamico",
  "source.issue.dynamic.secret.lease.e14a6cc2e8": "Issue dynamic secret lease",
  "source.issue.ephemeral.api.key.d864784cc7": "Issue ephemeral API key",
  "source.issue.first.certificate.4d8af98e7d": "Issue first certificate",
  "source.issue.leaf.from.47e7b2541d": "Issue leaf from",
  "source.issue.lease.96a70e0f64": "Emitir lease",
  "source.issue.pki.secret.692ee4b6e2": "Issue PKI secret",
  "source.issue.through.external.ca.671d1a629f": "Emitir mediante CA externa",
  "source.issue.your.first.certificate.8fbb374ce0": "Issue your first certificate",
  "source.issue.your.first.certificate.to.start.trac.355cebb739": "Issue your first certificate to start tracking and rotating credentials.",
  "source.issued.0221e48751": "Emitido",
  "source.issued.ssh.certificate.3775bb2dee": "Issued SSH certificate",
  "source.issuer.535c6f8eb5": "issuer",
  "source.issuer.catalog.add106b6a5": "Issuer catalog",
  "source.issuer.create.failed.1550974caf": "Issuer create failed",
  "source.issuer.filter.32db997051": "Issuer filter",
  "source.issuer.kind.9f06073f8d": "Issuer kind",
  "source.issuer.list.477db22fd7": "Issuer list",
  "source.issuer.metadata.unavailable.5b4cf4fcb5": "Issuer metadata unavailable",
  "source.issuer.visibility.859e72db07": "Issuer visibility",
  "source.json.editor.b58c887f78": "JSON editor",
  "source.json.import.bc2fd1db82": "JSON import",
  "source.json.spec.d53195334c": "JSON spec",
  "source.jwks.rollover.8e2a5cc316": "jwks rollover",
  "source.keep.emergency.issuance.guidance.close.by.6a05c2d327": "Keep emergency issuance guidance close by without mixing it into the execution form.",
  "source.key.99a52df3ff": "Key",
  "source.key.algorithm.36da451ea3": "Key algorithm",
  "source.key.backed.4eae20ec94": "Key-backed",
  "source.key.id.d54d56ee0a": "Key ID",
  "source.key.version.aa5d87c789": "Key version",
  "source.keyless.fulcio.42a397ffc7": "Keyless (Fulcio)",
  "source.kind.attributes.9505322c06": "Kind attributes",
  "source.kind.f5387f9bb6": "Tipo",
  "source.krl.1192cd9855": "KRL",
  "source.krl.revocation.7e579fb6c5": "KRL revocation",
  ...
  "source.last.hosted.tenant.ddd9f6cf68": "Last hosted tenant",
  "source.last.seen.21fd79c7de": "Last seen",
  "source.latch.this.first.run.guide.and.jump.into.d.708bd1e5a1": "Latch this first-run guide and jump into day-two certificate operations.",
  "source.lease.id.9730377afc": "Lease ID",
  "source.lease.state.70d08ad3df": "Lease state",
  "source.license.feature.de93785a58": "License feature",
  "source.license.tier.0c9a751553": "License tier",
  "source.lifecycle.identity.b788cc9a64": "Lifecycle identity",
  "source.lifecycle.state.machine.4fd45925e4": "Lifecycle state machine",
  "source.limit.674b0ed54b": "Limit",
  "source.line.d7852cd0d2": "Line",
  "source.load.next.metadata.page.8cd7685eed": "Load next metadata page",
  "source.load.sample.ac404ab475": "Load sample",
  "source.loading.agents.a4e0608f99": "Loading agents...",
  "source.loading.approvals.192880172b": "Loading approvals...",
  "source.loading.blast.radius.impact.from.graph.771409e0df": "Loading blast-radius impact from graph...",
  "source.loading.cbom.readiness.0b111b06ca": "Loading CBOM readiness...",
  "source.loading.certificate.details.a52129b338": "Loading certificate details...",
  "source.loading.certificates.3ed54a94d8": "Loading certificates...",
  "source.loading.comparison.58742d9f20": "Loading comparison...",
  "source.loading.connector.workflow.f8e0fc1515": "Loading connector workflow...",
  "source.loading.delivery.evidence.7f2cdadedd": "Loading delivery evidence...",
  "source.loading.discovery.findings.6d4fa8ee4b": "Loading discovery findings...",
  "source.loading.discovery.records.da1c8fab87": "Loading discovery records...",
  "source.loading.drift.remediation.c1b6240bc3": "Loading drift remediation...",
  "source.loading.graph.083d9e4f63": "Loading graph...",
  "source.loading.identities.45d7e0b5b9": "Loading identities...",
  "source.loading.identity.detail.0d1feafcee": "Loading identity detail...",
  "source.loading.incident.execution.evidence.83ace6ca73": "Loading incident execution evidence...",
  "source.loading.issuers.98644f83a7": "Loading issuers...",
  "source.loading.nhi.access.reviews.cd87c4f77e": "Loading NHI access reviews.",
  "source.loading.operations.f0b144434b": "Loading operations...",
  "source.loading.owners.8fcc1cacd9": "Loading owners…",
  "source.loading.profile.version.dc6b63b7c9": "Loading profile version...",
  "source.loading.profiles.12a7541833": "Loading profiles...",
  "source.loading.ssh.workflow.eee4586266": "Loading SSH workflow...",
  "source.loading.tools.efc190cd4c": "Loading tools...",
  "source.local.plaintext.to.encrypt.a67b9e7b54": "local plaintext to encrypt",
  "source.local.preview.http.957e66ac19": "Local preview HTTP",
  "source.machine.credential.access.bb586fcf38": "Machine credential access",
  "source.machine.login.e25f8c4843": "Inicio de sesión de máquina",
  "source.machine.login.failed.01826fdfc8": "Machine login failed",
  "source.machine.login.test.7f62ed2b92": "Machine login test",
  "source.managed.8f2de600bf": "Administrado",
  "source.managed.key.action.failed.934f359a98": "Managed-key action failed",
  "source.managed.key.custody.ba98c44d9c": "Managed key custody",
  "source.managed.key.f08acca719": "Managed key",
  "source.managed.key.id.8d05580702": "Managed key id",
  "source.managed.offering.f4e80765ae": "Managed offering",
  "source.manual.rotation.and.delete.1aee4da261": "Manual rotation and delete",
  "source.map.and.analysis.12782f32f8": "Map and analysis",
  "source.mappings.f64ec16b0d": "Mappings",
  "source.mark.managed.61a3f9305a": "Mark managed",
  "source.max.entries.per.poll.a77eca9293": "Max entries per poll",
  "source.maximum.validity.e745f2ab18": "Maximum validity",
  "source.mcp.53f13ae99e": "MCP",
  "source.mcp.tools.1a32c98e7f": "MCP tools",
  "source.message.2f77668a9d": "Mensaje",
  "source.message.bytes.to.mac.or.sign.1400a97072": "message bytes to MAC or sign",
  "source.method.52a0f9b65b": "Metodo",
  "source.minimum.ecdsa.bits.12eb67ca2f": "Minimum ECDSA bits",
  "source.minimum.rsa.bits.746e102467": "Minimum RSA bits",
  "source.minimum.score.e7461df96a": "Minimum score",
  "source.mint.a.fresh.signer.backed.ca.key.and.cert.4f35946ce6": "Mint a fresh signer-backed CA key and certificate for the selected authority while the previous issue URL keeps routing to the active successor.",
  "source.mint.a.one.time.enrollment.token.and.wait.41e91b176b": "Mint a one-time enrollment token and wait for the first in-network agent.",
  "source.mint.a.one.time.enrollment.token.install.a.d9cbac0c9e": "Mint a one-time enrollment token, install an agent inside the tenant network, then refresh this page when it registers.",
  "source.mint.api.token.f6cf0efff0": "Mint API token",
  "source.mint.ced97cc4a3": "Mint",
  "source.mint.enrollment.token.b50d28fa1d": "Mint enrollment token",
  "source.mode.visible.to.ui.8520f90032": "Mode visible to UI",
  "source.model.5e2c614c23": "Model",
  "source.model.context.protocol.read.only.assistant.6c1913a3c9": "Model Context Protocol: read-only assistant tools exposed by policy.",
  "source.move.to.beb8194bc4": "Move to",
  "source.multi.region.posture.e57c514674": "Multi-region posture",
  "source.mutation.c26ee0e4b9": "Mutation",
  "source.mutation.idempotency.e5fe0e928c": "Mutation idempotency",
  "source.name.dcd1d5223f": "Nombre",
  "source.name.id.kind.attribute.7d242f4e80": "name, id, kind, attribute",
  "source.native.secret.store.174d71834e": "Native secret store",
  "source.native.store.f4e7459e0a": "native store",
  "source.new.identity.51c2e7c139": "New identity",
  "source.new.profile.fcf4f3f4d5": "New profile",
  "source.new.request.5977ded363": "New request",
  "source.nhi.access.certification.3fd94ffdff": "NHI access certification",
  "source.nhi.access.review.campaigns.873389dac9": "NHI access review campaigns",
  "source.nhi.access.review.items.d360cac314": "NHI access review items",
  "source.nhi.access.review.unavailable.7f4d6bdefd": "NHI access review unavailable",
  "source.nhi.id.52919bf0d5": "ID NHI",
  "source.no.access.review.campaigns.5e5e0fbd56": "No access review campaigns.",
  "source.no.active.profiles.d3f9395f41": "No active profiles",
  "source.no.agents.enrolled.yet.345799ad5d": "No agents enrolled yet",
  "source.no.attested.svid.has.been.issued.in.this.b.8fee10fc2a": "No attested SVID has been issued in this browser session.",
  "source.no.attributes.returned.for.this.node.5b22b96afd": "No attributes returned for this node.",
  "source.no.broker.identity.has.been.issued.in.this.7bb702b9db": "No broker identity has been issued in this browser session.",
  "source.no.cbom.assets.returned.yet.6164e1adf5": "No CBOM assets returned yet",
  "source.no.cbom.readiness.assets.returned.yet.e6abce03d0": "No CBOM readiness assets returned yet",
  "source.no.ceremony.loaded.3e9d28986c": "No ceremony loaded",
  "source.no.certificates.yet.f1e2ab559a": "No certificates yet",
  "source.no.citations.returned.4c4de9598c": "No citations returned.",
  "source.no.commercial.feature.rows.825b068dda": "No commercial feature rows.",
  "source.no.connector.catalog.rows.were.returned.3a8d5bf05f": "No connector catalog rows were returned.",
  "source.no.connector.delivery.receipts.b8aaf68b4d": "No connector delivery receipts",
  "source.no.connector.receipts.86d1a1527d": "No connector receipts.",
  "source.no.connector.targets.5a8adcf783": "No connector targets",
  "source.no.connectors.registered.3752f19e55": "No connectors registered",
  "source.no.delivery.or.rotation.receipts.yet.21fb574bf8": "No delivery or rotation receipts yet",
  "source.no.deploy.outbox.attempt.has.produced.a.re.6e3133a027": "No deploy outbox attempt has produced a receipt yet.",
  "source.no.discovery.findings.7c8b4f0e23": "No discovery findings",
  "source.no.discovery.runs.e3ba4972a6": "No discovery runs",
  "source.no.discovery.schedules.17183fb10e": "No discovery schedules",
  "source.no.discovery.sources.b70fd7af27": "No discovery sources",
  "source.no.downstream.affected.nodes.were.returned.58352b876f": "No downstream affected nodes were returned.",
  "source.no.drift.remediation.findings.returned.yet.5034b41d52": "No drift remediation findings returned yet",
  "source.no.dynamic.lease.issued.yet.da6fd9c373": "No dynamic lease issued yet.",
  "source.no.extra.kind.attributes.were.returned.9f899e73ae": "No extra kind attributes were returned.",
  "source.no.fleet.reissuance.runs.have.been.recorde.0f1169b466": "No fleet reissuance runs have been recorded.",
  "source.no.graph.edges.match.the.current.filters.421adc32b8": "No graph edges match the current filters.",
  "source.no.graph.nodes.match.the.current.filters.d6f91b2251": "No graph nodes match the current filters.",
  "source.no.graph.nodes.yet.a1d126571e": "No graph nodes yet",
  "source.no.heartbeat.timestamp.7c01a4e0ea": "No heartbeat timestamp",
  "source.no.identities.currently.require.an.issue.r.3200466dfb": "No identities currently require an issue, rotate, or revoke approval.",
  "source.no.identities.yet.c8697bd1bc": "No identities yet",
  "source.no.incident.executions.have.been.recorded.b14b9f6701": "No incident executions have been recorded.",
  "source.no.issuers.yet.fc838bfd4a": "No issuers yet",
  "source.no.item.details.loaded.e93e8c8e0d": "No item details loaded.",
  "source.no.labels.in.this.pack.afb9ef5039": "No labels in this pack.",
  "source.no.managed.key.loaded.c921eb07f2": "No managed key loaded",
  "source.no.mcp.tools.are.available.for.this.tenant.66ea7cda3e": "No MCP tools are available for this tenant.",
  "source.no.more.certificate.pages.e8cec79bea": "No more certificate pages.",
  "source.no.nodes.or.edges.exist.for.this.tenant.ye.1643ac2e72": "No nodes or edges exist for this tenant yet. Ingest certificates or issue identities first.",
  "source.no.operations.found.7472e6ceb1": "No operations found",
  "source.no.pending.approvals.261de9be5f": "No pending approvals",
  "source.no.per.certificate.or.ephemeral.identity.b.c797515fce": "No per-certificate or ephemeral-identity billing. Certificate counters are",
  "source.no.profiles.yet.bd4729eb8f": "No profiles yet",
  "source.no.rotation.runs.cf68af2637": "No rotation runs.",
  "source.no.source.2eca7a588d": "No source",
  "source.no.spec.differences.de9813046a": "No spec differences.",
  "source.no.tenant.connector.targets.were.returned.6c7baa9a8d": "No tenant connector targets were returned.",
  "source.no.transit.ciphertext.yet.f9d6c9870b": "No transit ciphertext yet.",
  "source.node.545ea53846": "node",
  "source.node.a.66570ff05a": "node-a",
  "source.node.detail.79e07cc412": "Node detail",
  "source.node.kinds.ee50ba00ef": "Node kinds",
  "source.node.search.results.7531f516c1": "Node search results",
  "source.nodes.7ac362063b": "Nodes",
  "source.not.after.577c1c7930": "No después de",
  "source.not.before.69bf0cd3a1": "Not before",
  "source.not.browser.readable.cc2ff0b76e": "Not browser-readable",
  "source.notifications.788011833a": "Notificaciones",
  "source.offboard.9053e68ef6": "Retirar",
  "source.offboard.agent.f673bf87e3": "Offboard agent",
  "source.offboard.member.8a27787595": "Offboard member",
  "source.offboard.reason.6c2b7a820c": "Offboard reason",
  "source.offboarded.bc5f0c93d1": "Offboarded",
  "source.offboarded.by.4c49b0d40c": "Offboarded by",
  "source.offline.license.state.feature.rows.and.the.ee22ad090c": "Offline license state, feature rows, and the live crypto posture.",
  "source.oidc.mapping.status.358515bade": "OIDC mapping status",
  "source.oidc.mapping.status.and.api.token.administ.565d8d27fd": "OIDC mapping status and API-token administration are shown in Access administration below. This card only reflects the browser session and CSRF posture.",
  "source.onboard.member.a6dfe12142": "Onboard member",
  "source.one.time.share.token.20234cd9a0": "One-time share token",
  "source.one.time.sharing.9db928cd78": "One-time sharing",
  "source.only.valid.next.states.are.enabled.disable.643c38f3f4": "Only valid next states are enabled. Disabled targets are not sent to the backend.",
  "source.opaque.node.id.660e5de3ee": "Opaque node ID",
  "source.open.audit.explorer.e155d6131a": "Open audit explorer",
  "source.open.expiring.certificates.45cc9bb64d": "Open expiring certificates",
  "source.open.posture.71199986c4": "Open posture",
  "source.openssl.p10cr.ac3c5c9967": "OpenSSL p10cr",
  "source.openssl.query.5ae6b22e8f": "OpenSSL query",
  "source.openssl.verify.64d6554ef1": "OpenSSL verify",
  "source.operations.queue.42686cb416": "Operations queue",
  "source.operations.unavailable.b176555a53": "Operations unavailable",
  "source.operator.attestations.bb1bff1074": "Operator attestations",
  "source.optional.59be71333c": "Optional",
  "source.optional.associated.data.52eba643ce": "optional associated data",
  ...
  "source.owner.id.1611f5e055": "Owner ID",
  "source.owner.id.768c061c71": "owner id",
  "source.owner.id.da58f15949": "Owner id",
  "source.owner.kind.eb9923cec7": "Tipo de propietario",
  "source.owner.name.id.email.or.kind.d0081dd7f1": "Owner name, ID, email, or kind",
  "source.owner.status.74d91b61ae": "Owner status",
  "source.owners.58f5df9b24": "Propietarios",
  "source.packaging.0d62bb01df": "Packaging",
  "source.packaging.edition.matrix.265d443ef4": "Packaging edition matrix",
  "source.page.size.bd69e66e00": "Page size",
  "source.passive.read.state.model.projections.can.b.9f2d6a2da6": "Passive-read-state model: projections can be read from follower regions while the write path stays on one writable region per tenant.",
  "source.path.62fa5a5b0d": "Ruta",
  "source.payments.api.682a1c47a1": "payments-api",
  "source.payments.pii.643f35ba95": "payments-pii",
  "source.pem.is.required.0a8b6ce9cc": "PEM is required.",
  "source.pending.64e6bbf0cf": "pending ·",
  "source.permission.boundary.c0d351ef86": "permission boundary",
  "source.permissions.abccc78cc9": "Permissions",
  "source.pki.as.a.secret.e349ae9d0f": "PKI as a secret",
  "source.pki.issue.failed.cb50a25278": "PKI issue failed",
  "source.pkioperation.f57e1d9c16": "PKIOperation",
  "source.plan.fa8ed0bdab": "Plan",
  "source.policy.decisions.988b13232e": "Policy decisions",
  "source.postgresql.17197ea102": "· PostgreSQL",
  "source.postgresql.cc52d03280": "PostgreSQL",
  "source.prepare.delete.6d0f9a0ea2": "Prepare delete",
  "source.prepare.rotate.9534e0ec7e": "Prepare rotate",
  "source.preview.ui.without.backend.ad12297cd6": "Preview UI without backend",
  "source.preview.uses.sample.data.in.this.browser.a.7b39b478d2": "Preview uses sample data in this browser and stores no sign-in token. Production builds still require SSO.",
  "source.principal.afc19f1734": "Principal",
  "source.privilege.d4d7c3497b": "Privilege",
  "source.privilege.label.128cc84317": "Privilege label",
  "source.prod.k8s.42d6181646": "prod-k8s",
  "source.product.evidence.1b4586bcc7": "Product evidence",
  "source.production.acme.c76ba14398": "Production ACME",
  "source.professional.services.package.table.60626ecbca": "Professional services package table",
  "source.profile.authoring.mode.4bba88d160": "Profile authoring mode",
  "source.profile.comparison.unavailable.70eb2b404e": "Profile comparison unavailable",
  "source.profile.d696a35bdd": "Perfil",
  "source.profile.diff.e8bc2bbc32": "Profile diff",
  "source.profile.evaluations.fc73272085": "Profile evaluations",
  "source.profile.filter.d447429270": "Profile filter",
  "source.profile.list.unavailable.3759c2905e": "Profile list unavailable",
  "source.profile.name.d3663280e1": "Nombre de perfil",
  "source.profile.rejected.e9c8593d8e": "Profile rejected",
  "source.profile.version.unavailable.ec6a0646c4": "Profile version unavailable",
  "source.proof.payloads.are.submitted.directly.and.893894a52b": "Proof payloads are submitted directly and cleared after the broker returns identity metadata.",
  "source.protocol.cf0883343f": "Protocol",
  "source.protocol.register.6109f4cf46": "Protocol register",
  "source.protocol.responder.status.e57eff8ebc": "Protocol responder status",
  "source.protocol.status.check.failed.d6b8e1268d": "Protocol status check failed",
  "source.protocols.1019490835": "Protocolos",
  "source.provider.472590ae97": "Proveedor",
  "source.provider.plane.47b8ba879c": "Provider plane",
  "source.provider.unit.7e58335a9f": "Provider unit",
  "source.provision.tenant.e6e411f04c": "Provision tenant",
  "source.public.key.4ee252fb73": "Public key",
  "source.public.key.der.606443a2d8": "Public key (DER)",
  "source.query.b80a37564f": "Consulta",
  "source.query.rca.and.mcp.fail.closed.when.disable.255478de84": "Query, RCA, and MCP fail closed when disabled. Tenant and RBAC scope come from the authenticated session/API token, never from a browser field.",
  "source.question.289aff12b0": "Question",
  "source.queue.3b2fe03e36": "Queue",
  "source.queue.a.servicenow.table.api.ticket.throug.0df778f34b": "Queue a ServiceNow Table API ticket through the same event log and outbox used for credential workflows.",
  "source.raw.668ba48102": "(raw",
  "source.raw.attestation.evidence.stays.out.of.the.6ffaf184fc": "Raw attestation evidence stays out of the browser",
  "source.raw.fec6060499": ", raw",
  "source.rca.answers.are.sufficient.or.insufficient.5a9397d141": "RCA answers are sufficient or insufficient based on cited evidence. Hostile record text is rendered as inert text, and next actions stay links or text until a remediation workflow exists.",
  "source.rca.d93580ed3a": "RCA",
  "source.rca.evidence.workspace.418f458f5f": "RCA evidence workspace",
  "source.re.key.ca.4aadf37c7a": "Re-key CA",
  "source.reachability.unavailable.526510e61e": "Reachability unavailable",
  "source.reachable.from.ea74f7acc4": "reachable from",
  "source.reachable.nodes.ebf8d10fa5": "Reachable nodes",
  "source.read.only.responder.probe.23655af063": "Read-only responder probe",
  "source.readonly.reporting.ddf5aecb22": "readonly-reporting",
  "source.ready.for.certificate.operations.e99f6e538f": "Ready for certificate operations",
  "source.reason.3425d10869": "Reason:",
  "source.reason.f81ab834de": "Motivo",
  "source.reason.for.revoke.or.exception.5df8423828": "Reason for revoke or exception",
  "source.recent.activity.6cb44b5633": "Recent activity",
  "source.recent.connector.delivery.receipts.3a2bf7db18": "Recent connector delivery receipts",
  "source.recent.delivery.receipts.a9cb8f42a9": "Recent delivery receipts",
  "source.recent.lifecycle.rotation.runs.4de11752b6": "Recent lifecycle rotation runs",
  "source.recorded.approvals.and.required.approvals.4d359a312b": "Recorded approvals and required approvals for this request.",
  "source.redacted.reference.f904f7809b": "Redacted reference",
  "source.redaction.boundary.134ed7be9f": "Redaction boundary:",
  "source.redeem.one.time.share.2294329e1f": "Redeem one-time share",
  "source.redeem.share.1b54732322": "Redeem share",
  "source.redeemed.share.value.1455d94a16": "Redeemed share value",
  "source.redis.a7f6415749": "Redis",
  "source.refresh.0e91610117": "Refresh",
  "source.refresh.records.60bf2f8d78": "Refresh records",
  "source.region.d3a008ef13": "Región",
  "source.registered.dfd1beafbf": "registered.",
  "source.reject.request.33b1a3b501": "Reject request",
  "source.reload.command.cf1acb1111": "Reload command",
  "source.remote.key.b698762058": "Remote key",
  "source.remove.row.1810fddd9e": "Remove row",
  "source.renew.90c1689b0b": "Renew",
  "source.renew.lease.b730aa5628": "Renew lease",
  "source.renewal.history.771f739290": "Renewal history",
  "source.renewal.jobs.ef0c816533": "Renewal jobs",
  "source.reopen.setup.guide.0f10355fd2": "Reopen setup guide",
  "source.replacement.cefd665229": "Replacement",
  "source.replacement.identity.name.503334612e": "Replacement identity name",
  "source.replacement.value.81858184c6": "Replacement value",
  ...
  "source.request.boundary.4ba2298c84": "Request boundary",
  "source.request.credential.014a4a64ca": "Solicitar credencial",
  "source.request.failed.cfce761bef": "Request failed",
  "source.requested.by.42aea0b1dd": "· requested by",
  "source.requester.b5687cf04a": "Requester",
  "source.reset.daee7606b3": "Reset",
  "source.responder.status.85b7b015dc": "Responder status",
  "source.response.9061383b8e": "Respuesta",
  "source.restore.previous.binding.3e3a4f657d": "restore previous binding",
  "source.restore.previous.bindings.ec8f60be98": "restore previous bindings",
  "source.retire.da8597f3f2": "Retire",
  "source.retire.ssh.host.6d1acfd432": "Retire SSH host",
  "source.reveal.failed.f00b1b5ba6": "Reveal failed",
  "source.reveal.once.81d2e1991a": "Reveal once",
  "source.reveal.once.api.token.8cfd65d574": "Reveal-once API token",
  "source.reveal.once.key.issuance.61c20133fa": "Reveal-once key issuance",
  "source.review.approvals.51320f88b0": "Review approvals",
  "source.reviewer.63c2827d64": "· reviewer",
  "source.reviewer.d29f46772c": "Reviewer",
  "source.revocation.reason.b11670420f": "Revocation reason",
  "source.revoke.87e6d00bbf": "Revocar",
  "source.revoke.and.publish.krl.d5e98fd13c": "Revoke and publish KRL",
  "source.revoke.certificate.for.a0ed3562dc": "Revoke certificate for",
  "source.revoke.lease.a04f91a939": "Revoke lease",
  "source.revoke.selected.38b0352f6d": "Revoke selected (",
  "source.revoke.ssh.certificate.63b6e335c3": "Revoke SSH certificate",
  "source.revoked.at.144e77bcf0": "Revoked at",
  "source.revoked.certs.267c0b721b": "Revoked certs",
  ...
  "source.risk.band.thresholds.e80274c7e5": "Risk band thresholds",
  "source.risk.bands.1584b73418": "Risk bands",
  "source.risk.row.992824cf5e": "Risk row",
  "source.role.14736a2eb9": "Rol",
  "source.role.catalog.d2bfa0ab0e": "Role catalog",
  "source.roles.c253370554": "Roles",
  "source.rollback.c591f55749": "Revertir",
  "source.rollback.failed.manual.intervention.requir.113a558395": "Rollback failed — manual intervention required.",
  "source.rollback.instructions.8fb506160a": "Rollback instructions",
  "source.rollback.plan.952efc8286": "Rollback plan",
  "source.root.cause.analysis.fde4017d48": "Root-cause analysis",
  "source.rotate.c3613b1704": "Rotar",
  "source.rotate.exposed.tls.private.key.8868cb8fa7": "Rotate exposed TLS private key",
  "source.rotate.first.f4ea83b5ca": "Rotate first",
  "source.rotate.scep.challenge.for.3553645d3e": "Rotate SCEP challenge for",
  "source.rotate.secret.4405518d27": "Rotate secret",
  "source.rotation.57b5e2fc1b": "Rotation",
  "source.rotation.failed.2d3e7bd0f1": "Rotation failed",
  "source.rows.bc51e9e65d": "rows",
  "source.rule.62845f31a2": "Rule",
  "source.rules.4228aeb07c": "Rules",
  "source.run.00d60e31a4": "Ejecución",
  "source.run.a.scan.against.tls.endpoints.or.host.c.e657e656ce": "Run a scan against TLS endpoints or host config paths. The inventory table stays empty until trstctl returns tenant-scoped assets.",
  "source.run.access.test.0a1ca1e976": "Run access test",
  "source.run.due.now.06b5403e4c": "Run due now",
  "source.run.ea64488842": "run:",
  "source.run.graph.query.3e99f2000a": "Run graph query",
  "source.run.id.26d3e7aaac": "Run ID",
  "source.run.rotation.399dcb292b": "Run rotation",
  "source.run.scan.68ac7da5df": "Run scan",
  "source.run.secret.scan.89f2ed7a1b": "Run secret scan",
  "source.run.uuid.0b1b6844cb": "run uuid",
  "source.running.f4ccae29e1": "Running",
  "source.runs.848f54e896": "Ejecuciones",
  "source.runs.appear.here.after.a.source.is.created.da81c4a3c9": "Runs appear here after a source is created and a tenant-scoped scan is queued.",
  "source.sans.7a15c9b7f6": "SANs",
  "source.save.1509f561f2": "Save",
  "source.save.the.one.time.token.with.0600.permissi.b35e2c6935": "Save the one-time token with 0600 permissions, then run the agent where it can reach the control plane. Agent enrollment tokens cannot issue certificates.",
  "source.scanner.71d4cf953e": "Scanner",
  "source.schedule.a.recurring.scan.once.a.source.ex.e7c14af000": "Schedule a recurring scan once a source exists, or refresh to pick up work created by another operator.",
  ...
  "source.sdk.and.cli.examples.contain.only.names.te.f056ba97a8": "SDK and CLI examples contain only names, tenants, and versions. The access test performs a read without rendering the value.",
  "source.search.49c266baaa": "Search",
  "source.search.owners.55a040f1a5": "Search owners",
  "source.secret.7e32a729b1": "Secreto",
  "source.secret.access.test.e467205dc5": "Secret access test",
  "source.secret.create.failed.885c3ecf7c": "Secret create failed",
  "source.secret.identity.62453fba82": "Secret identity",
  "source.secret.metadata.ad1b1e1608": "Secret metadata",
  "source.secret.operations.are.fail.closed.until.th.09b52b9f62": ". Secret operations are fail-closed until the feature is enabled and a key-encryption key is configured.",
  "source.secret.payments.db.password.cf46ca15a9": "Secret/payments-db/password",
  "source.secret.scan.failed.61f13676c4": "Secret scan failed",
  "source.secret.scan.findings.3462f78805": "Secret scan findings",
  "source.secret.sync.and.platform.integrations.90c8c57a01": "Secret sync and platform integrations",
  "source.secret.sync.failed.b901ae57d8": "Secret sync failed",
  "source.secret.to.delete.6abd642165": "Secret to delete",
  "source.secret.to.rotate.4e6aab975e": "Secret to rotate",
  "source.secret.value.6ef47d9880": "Secret value",
  "source.secrets.api.unavailable.or.disabled.90f9a5c4b4": "Secrets API unavailable or disabled",
  "source.secrets.d8707d411d": "Secretos",
  "source.select.2a78025de6": "Select",
  "source.select.a.graph.node.to.inspect.its.attribu.fcb3894777": "Select a graph node to inspect its attributes and drilldown links.",
  "source.select.an.audit.event.to.inspect.its.immut.b522affee1": "Select an audit event to inspect its immutable sequence, hash, actor, and data payload.",
  "source.select.authority.b2858bf4f3": "Select authority",
  "source.select.identity.1b8c8195aa": "Select identity",
  "source.select.predecessor.ec02008346": "Select predecessor",
  "source.select.successor.ea343d0bff": "Select successor",
  "source.select.target.adfbe7a33d": "Select target",
  "source.selected.57fd7a0cf3": "Selected",
  "source.selected.certificate.4d9927e917": "selected certificate",
  "source.selected.identities.a829228e71": "selected identities?",
  "source.selected.node.f8716e2fce": "Selected node",
  "source.selected.spec.757c23e3eb": "Selected spec",
  "source.selectors.d27e6f722c": "Selectors",
  "source.send.the.subject.scopes.and.ttl.to.issue.a.9854a77221": "Send the subject, scopes, and TTL to issue a short-lived token. Copy the returned token from the reveal panel, then dismiss it so browser memory drops the raw key.",
  "source.sensitivity.label.8a52af2e9c": "Sensitivity label",
  "source.sequence.0740f4bade": "Sequence",
  "source.serial.0144b1defc": "serial",
  "source.serial.8ea0949377": "Serie",
  "source.server.expiry.filter.129321a4ff": "Server expiry filter",
  "source.service.catalog.task.6c47887640": "Service catalog task",
  "source.service.d677190e0a": "Service",
  "source.service.name.1bb8870cc0": "Service name",
  "source.service.tls.for.staging.7d9f743b3b": "service TLS for staging",
  ...
  "source.servicenow.ticket.failed.75f1ff3ff8": "ServiceNow ticket failed",
  "source.servicenow.ticket.queued.aaa6fd780e": "ServiceNow ticket queued",
  "source.servicenow.ticket.token.77e4d20179": "servicenow-ticket-token",
  "source.session.id.cb9ac5c561": "Session ID",
  "source.set.up.trstctl.b56c208e41": "Set up trstctl",
  "source.setup.complete.aadaf35950": "Setup complete",
  "source.severity.5e9f98120d": "Severidad",
  "source.share.create.failed.9078694d49": "Share create failed",
  "source.share.redeem.failed.674fa95c57": "Share redeem failed",
  "source.share.token.f3310a3b89": "Share token",
  "source.showing.d604310a78": "Showing",
  "source.shown.once.22548d041f": "Shown once",
  "source.sign.an.artifact.fb729a3d5b": "Sign an artifact",
  "source.sign.in.bfd402b2f6": "Sign in",
  "source.sign.in.with.sso.73e984e9b4": "Sign in with SSO",
  "source.sign.intermediate.csr.with.64b849b64d": "Sign intermediate CSR with",
  "source.sign.message.516e35c2fc": "Sign message",
  "source.signature.f1a73e2204": "Signature",
  "source.signature.receipt.8d8dcf3028": "Signature receipt",
  "source.signed.evidence.bundle.ready.9ce177ede7": "Signed evidence bundle ready",
  "source.signed.export.plus.offline.verification.ke.f03caf9838": "Signed export plus offline verification key for auditor handoff.",
  "source.signing.key.49395b9594": "Signing key",
  "source.signing.mode.0ba52a4363": "Signing mode",
  "source.simpleenroll.4ea6ad8043": "simpleenroll",
  "source.six.factor.breakdown.a9a77981b1": "Six-factor breakdown",
  "source.six.factor.breakdown.for.e30661db39": "Six-factor breakdown for",
  "source.skipped.22a5b0caf3": "(skipped",
  "source.slo.tier.9d31a12006": "SLO tier",
  "source.source.0e570ca6fa": "Origen",
  "source.source.template.f2c4cfbcec": "Source template",
  "source.source.uuid.266dd280b0": "source uuid",
  "source.sources.caf85b0888": "Fuentes",
  "source.spec.preview.73cee36c4b": "Spec preview",
  "source.spiffe.helper.7ba7061b6b": "spiffe-helper",
  "source.ssh.ca.and.krl.status.f38597dc96": "SSH CA and KRL status",
  "source.ssh.certificate.identity.d5833485f8": "SSH certificate identity",
  "source.ssh.deployment.and.trust.rollout.098d316f31": "SSH deployment and trust rollout",
  "source.ssh.key.identity.b8252e7aa8": "SSH key identity",
  "source.ssh.public.key.c9be6a369e": "SSH public key",
  "source.ssh.trust.8a25c0e13c": "Confianza SSH",
  "source.ssh.workflow.failed.e76cbdb07c": "SSH workflow failed",
  "source.stale.heartbeat.d8742526e2": "Stale heartbeat",
  "source.start.a.ceremony.to.see.its.purpose.approv.9f9d9ee9fd": "Start a ceremony to see its purpose, approval threshold, and status.",
  "source.start.a.root.ca.ceremony.then.record.a.sec.da658d7848": "Start a root CA ceremony, then record a second custodian approval before using the ceremony for a signer-backed authority action.",
  "source.start.re.key.ceremony.c2e02a1a0c": "Start re-key ceremony",
  "source.start.root.ceremony.01836ae713": "Start root ceremony",
  "source.start.with.a.profile.bound.request.or.conn.19cdbff548": "Start with a profile-bound request, or connect an issuer before the first certificate is minted.",
  "source.state.a3b50c4767": "Estado",
  "source.status.920e413c7d": "Estado",
  "source.status.filter.9bfe8b184f": "Filtro de estado",
  "source.structured.query.preview.706d53d9be": "Structured query preview",
  "source.subject.5dcd66f2ed": "| subject",
  "source.subject.6897128384": "Sujeto",
  "source.submit.request.917e144e4b": "Submit request",
  "source.submitted.proof.fields.are.cleared.after.i.b9215d2471": "Submitted proof fields are cleared after issue. Returned certificate PEM and claim maps are discarded before the row is stored.",
  "source.succeeded.5dceaeceb6": "succeeded",
  "source.succeeded.6d9a6f97a5": "Succeeded",
  "source.successor.activation.2c89a6285d": "Successor activation",
  "source.successor.d29e68e27e": "Successor",
  "source.sufficient.means.the.cited.evidence.is.eno.07cb72f36c": "Sufficient means the cited evidence is enough to answer without guessing.",
  "source.support.tier.2dfba0f890": "Support tier",
  "source.surface.0905f7f590": "Superficie",
  "source.surfaces.fbb4dbb2d8": "Surfaces",
  "source.svc.internal.e50a91019d": "svc.internal",
  "source.sync.secret.4d3ab1c075": "Sync secret",
  "source.sync.stored.secret.b83b2d0767": "Sync stored secret",
  "source.table.16d1c9050a": "Table",
  "source.target.978354db0c": "Destino",
  "source.target.actions.4d6d059ed8": "Target actions",
  "source.target.hosts.b345027096": "Target hosts",
  "source.targets.27445f6ab6": "Targets",
  "source.team.filter.f485fa9dcf": "Team filter",
  "source.tenant.binding.73a4b393b8": "Tenant binding",
  "source.tenant.boundary.4b458df962": "Tenant boundary",
  "source.tenant.e23969d284": "Tenant",
  "source.tenant.id.from.session.fb2bbbb246": "Tenant ID from session",
  "source.tenant.members.7c3b607c20": "Tenant members",
  "source.test.532eaabd95": "Test",
  "source.test.login.c5e0ad20c3": "Test login",
  "source.the.agent.row.remains.as.an.offboarded.tom.42a25faa10": "The agent row remains as an offboarded tombstone, and future mTLS RPCs from this agent are rejected.",
  "source.the.broker.api.issues.a.single.identity.pe.7e53bfbe2b": "The broker API issues a single identity per request. A tenant-wide broker history list is not available in the browser contract yet, so this table shows identities returned during this session.",
  "source.the.browser.never.chooses.a.tenant.id.thro.091c4e9bb3": "The browser never chooses a tenant id through a route, query string, or form field. The backend session or API token supplies it, and PostgreSQL RLS enforces it below the API.",
  "source.the.cbom.scanner.inventories.algorithms.ke.94de5272b7": "The CBOM scanner inventories algorithms, key sizes, TLS versions, and weak crypto posture. The policy floor is RSA-2048, EC-256, and TLS 1.2, while 3DES/DES/RC4/NULL/EXPORT/MD5 are banned.",
  "source.the.console.could.not.read.runtime.status.a01258a71d": "The console could not read runtime status, so it shows the safe baseline: no confirmed model means no confirmed prompt egress.",
  "source.the.console.is.currently.loaded.over.an.en.4e9bab4e91": "The console is currently loaded over an encrypted browser connection.",
  "source.the.console.reads.projected.connector.deli.091ecd8115": "The console reads projected connector delivery receipts and lifecycle rotation runs. These are audit-safe routing records: no certificate private key or secret value is returned.",
  "source.the.local.vite.preview.is.http.production.7f2e105c44": "The local Vite preview is HTTP. Production should be HTTPS or mTLS-terminated before operators use it.",
  "source.the.native.store.returns.names.and.version.6f88143feb": "The native store returns names and versions only. Create and rotate send a value once, then this page drops the input and shows metadata.",
  "source.the.register.checks.the.same.origin.protoc.851c152de8": "The register checks the same-origin protocol responder paths the control plane mounts. A protocol is shown as off only when its responder path is missing or unavailable.",
  "source.the.request.sends.endpoint.and.host.config.057e53f9e9": "The request sends endpoint and host-config locators only. Inventory rows are loaded from the tenant-scoped CBOM asset endpoint after the scan.",
  "source.this.json.is.sent.to.the.profile.workflow.37a80f1c5b": "This JSON is sent to the profile workflow. The backend remains the source of truth.",
  "source.this.month.5510b12a58": "this month",
  "source.this.plaintext.was.decoded.locally.from.th.fbd3275222": "This plaintext was decoded locally from the transit response. Dismiss clears it from the page.",
  "source.this.submits.a.single.bulk.revocation.requ.ab3df219e2": "This submits a single bulk revocation request for the",
  "source.this.submits.one.bulk.revocation.request.f.f1809ceaf2": "This submits one bulk revocation request for all",
  "source.this.tenant.has.no.credentials.yet.the.fou.7b31a81e81": "This tenant has no credentials yet. The four-step setup connects an issuer, issues your first certificate, and enrolls an agent — about five minutes. Prefer to look around first? Explore the console.",
  "source.this.value.is.the.exact.once.redeem.result.ed19b63953": "This value is the exact-once redeem result. A second redeem should fail.",
  "source.this.view.shows.issuer.name.kind.public.ke.5166a2828e": "This view shows issuer name, kind, public key, custody boundary, and chain metadata. The ceremony and managed-key panels below drive the corresponding protected workflows.",
  "source.ticket.description.a277a242bf": "Ticket description",
  "source.ticket.request.17c5294c85": "Ticket request",
  "source.ticket.summary.aafe32b23d": "Ticket summary",
  "source.ticket.table.bfbfbeffa9": "Ticket table",
  "source.tier.cb9e8664ed": "Tier",
  "source.time.to.expiry.b1bf11183a": "time to expiry",
  "source.tls.endpoints.c928457ec8": "TLS endpoints",
  "source.to.663ea1bfff": "to",
  "source.to.f4b06ef6d3": "To",
  "source.to.v.0969544edf": "to v",
  "source.token.reference.f98f4b9710": "Token reference",
  "source.tool.2e53bdcd07": "Tool",
  "source.tool.ef19e27e34": "Tool:",
  "source.tools.are.7c933884d0": "Tools are",
  "source.tools.f9d35d4377": "tools",
  "source.track.and.renew.certificates.f0f36882b6": "Track and renew certificates",
  "source.transit.and.kmip.bbf61786e0": "Transit and KMIP",
  "source.transit.encrypt.and.decrypt.f3ae0fd83f": "Transit encrypt and decrypt",
  "source.transit.operation.failed.22502fa40b": "Transit operation failed",
  "source.transit.operations.keep.key.material.serve.be62c8b11a": "Transit operations keep key material server-side. This page base64-encodes local plaintext for the API, clears plaintext inputs after encrypt, and shows decrypted values only in a reveal panel.",
  "source.transit.result.7a54cd2a67": "Transit result",
  "source.transition.reason.2b9e603491": "Transition reason",
  "source.transport.aaead4abf5": "Transport",
  "source.trigger.8b9c643731": "Trigger",
  "source.trstctl.74de2c6ee4": "trstctl",
  "source.trstctl.will.track.this.credential.and.ale.258f3fc1df": "trstctl will track this credential and alert before expiry. Renewal is a manual, one-click action today.",
  "source.ttl.seconds.862d08de5a": "Segundos de TTL",
  "source.type.baaddf70fb": "Tipo",
  "source.type.credential.name.to.confirm.cc8d26a179": "Type credential name to confirm",
  "source.type.filter.5607113309": "Filtro de tipo",
  "source.type.the.exact.secret.name.8106c6efde": "Type the exact secret name",
  "source.typescript.sdk.40e0532135": "TypeScript SDK",
  "source.unknown.b764cdc0ea": "Desconocido",
  "source.unparseable.heartbeat.timestamp.bb97c8934b": "Unparseable heartbeat timestamp",
  "source.updated.3a5ecca188": "Updated",
  "source.updates.22e2bada8f": "Updates",
  "source.urgency.03d37e9a53": "Urgency",
  "source.use.internal.ca.2181607010": "Use internal CA",
  "source.valid.before.8b8acd434a": "| valid before",
  "source.validity.9c3050e867": "Validity",
  "source.value.handling.f20f0a6806": "Value handling",
  "source.value.to.share.fa56b0a913": "Value to share",
  "source.verified.4f7838402f": "Verified",
  "source.version.dd167905de": "Version",
  "source.via.4d327af41f": "via",
  "source.view.all.9a780508de": "View all →",
  "source.view.certificates.dcc999606f": "View certificates",
  "source.view.details.d1bf045bb5": "View details",
  "source.waiting.for.the.agent.to.register.3e78d9c8a6": "Waiting for the agent to register...",
  "source.was.issued.fe1574675b": "was issued.",
  "source.was.reachable.and.the.value.was.not.render.830c77edbc": "was reachable, and the value was not rendered.",
  "source.was.returned.for.this.secret.dismiss.clear.67402c3c18": "was returned for this secret. Dismiss clears it from the page.",
  "source.watched.domains.0a60ff7e19": "Watched domains",
  "source.web.server.e4d165cf07": "web-server",
  "source.welcome.to.trstctl.let.s.set.it.up.7d04de0c8b": "Welcome to trstctl — let's set it up",
  "source.what.happened.483bd49023": "What happened",
  "source.which.certificates.should.rotate.first.218489c622": "Which certificates should rotate first?",
  "source.why.did.this.identity.become.high.risk.d0f95f73e1": "Why did this identity become high risk?",
  "source.workflow.available.3946309163": "Workflow available",
  "source.workload.identity.ebfedeba5e": "Workload identity",
  "source.x.509.certificate.identity.ac455e032b": "X.509 certificate identity",
  "source.x.crypto.acme.e3bd443082": "x/crypto/acme",
  "source.your.session.cannot.read.tenant.approval.r.220db554b4": "Your session cannot read tenant approval requests.",
  "source.your.session.cannot.read.tenant.audit.evid.6c0890fb54": "Your session cannot read tenant audit evidence.",
  "source.your.session.cannot.read.the.credential.gr.556ee31338": "Your session cannot read the credential graph for this tenant.",
...
const deDECatalog = {
  ...
  "source.lifecycle.state.plus.projected.connector.a.efb351b308": "Lifecycle-Zustand plus projizierte Connector- und Rotationsevidenz, sobald ein Outbox-Worker sie erzeugt hat.",
  ...
  "source.credential.name.911c43d9f0": "Credential name",
  "source.credentials.issued.per.month.11bd254ee7": "credentials issued per month",
  "source.crypto.agility.means.the.system.can.see.we.6ff0a0d217": "Kryptoagilität bedeutet, dass das System schwache Algorithmen sehen, unzulässige Entscheidungen ablehnen und sichere Rotationen planen kann, ohne aus reinem Browser-Zustand zu raten.",
  "source.crypto.agility.readiness.7bc9bc7019": "Crypto-agility readiness",
  "source.cryptographic.bill.of.materials.an.invento.b2a4a4fd81": "Cryptographic Bill of Materials: an inventory of algorithms, key sizes, protocols, and crypto posture.",
  "source.csrf.cookie.04ee351267": "CSRF cookie",
  "source.csv.upload.1a9c1686fd": "CSV upload",
  ...
  "source.the.broker.api.issues.a.single.identity.pe.7e53bfbe2b": "The broker API issues a single identity per request. A tenant-wide broker history list is not available in the browser contract yet, so this table shows identities returned during this session.",
  "source.the.browser.never.chooses.a.tenant.id.thro.091c4e9bb3": "The browser never chooses a tenant id through a route, query string, or form field. The backend session or API token supplies it, and PostgreSQL RLS enforces it below the API.",
  "source.the.cbom.scanner.inventories.algorithms.ke.94de5272b7": "Der CBOM-Scanner inventarisiert Algorithmen, Schlüsselgrößen, TLS-Versionen und schwache Kryptolage. Die Richtlinienuntergrenze ist RSA-2048, EC-256 und TLS 1.2; 3DES/DES/RC4/NULL/EXPORT/MD5 sind verboten.",
  "source.the.console.could.not.read.runtime.status.a01258a71d": "The console could not read runtime status, so it shows the safe baseline: no confirmed model means no confirmed prompt egress.",
  "source.the.console.is.currently.loaded.over.an.en.4e9bab4e91": "The console is currently loaded over an encrypted browser connection.",
  "source.the.console.reads.projected.connector.deli.091ecd8115": "The console reads projected connector delivery receipts and lifecycle rotation runs. These are audit-safe routing records: no certificate private key or secret value is returned.",
  "source.the.local.vite.preview.is.http.production.7f2e105c44": "The local Vite preview is HTTP. Production should be HTTPS or mTLS-terminated before operators use it.",
