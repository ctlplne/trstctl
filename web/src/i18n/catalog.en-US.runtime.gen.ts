...
export const defaultMessageValues = [
  ...
  "Review exact plan",
  "Confirm normalized scope, data handling, permission, and estimated work before anything is saved.",
  ...
  "Requires",
  "Authorized scope",
  "Create the declared scope first. It is the denominator for honest coverage.",
  "Network relay",
