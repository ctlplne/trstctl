...
export const defaultMessageValues = [
  ...
  "Cancel",
  "Confirm seal",
  "Offline license state, edition and feature rows, FIPS posture, and distribution.",
  ...
  "This module requires a commercial edition — view Editions & license",
  "Upgrade",
  ...
  "Migration plan",
  "Assess plan",
  "Assessment changes nothing. Review before starting.",
  "Migratable: {value1}/{value2} members.",
  "Waves",
  "All kinds",
  "All profiles",
  "All statuses",
  ...
  "No identities currently require an issue, rotate, or revoke approval.",
  "No identities yet",
  ...
  "Offboarded",
  "Offboarded by",
  "Offline license state, feature rows, and the live crypto posture.",
  "OIDC mapping status",
  ...
  "was returned for this secret. Dismiss clears it from the page.",
  "Watched domains",
  "web-server",
