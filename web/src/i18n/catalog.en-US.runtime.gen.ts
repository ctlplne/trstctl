...
export const defaultMessageValues = [
  ...
  "System posture",
  "Editions & license",
  "Membership, API tokens, offboarding, and just-in-time privileged sessions for this tenant.",
  ...
  "Assign roles and tokens",
  "Members, roles, API tokens, and offboarding are all administered on the Platform access tab.",
