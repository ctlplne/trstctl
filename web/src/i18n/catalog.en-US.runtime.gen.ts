...
export const defaultMessageValues = [
  ...
  "Certificates",
  "Certificates & PKI",
  "How are certificates issued, renewed, and trusted?",
  "Secrets",
  "How do machines receive and rotate secrets safely?",
  "SSH",
  "Signing",
  "Fleet",
  "Workload & SSH",
  "Who is this machine, and what can it access?",
  "Posture & response",
  "What is wrong, and what could be affected?",
  "Platform",
  "How is the control plane protected and operated?",
  "Home",
  "Spaces",
  "Store & engines",
  "Workload identity",
