...
export const defaultMessageValues = [
  ...
  "Affected systems are still loading from the served credential graph.",
  "Affected systems are unknown: {error}",
  "{count} downstream system is in the served graph impact.",
  "{count} downstream systems are in the served graph impact.",
