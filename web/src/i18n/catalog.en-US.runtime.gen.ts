...
export const defaultMessageValues = [
  ...
  "Fetch the contract",
  "The OpenAPI 3.1 document is the source of truth; the API Explorer renders it live.",
  ...
  "API explorer",
  "Select a contract operation, mint a short-lived scoped test key, run the request, and inspect the response.",
  "Integration hub",
  "Loading contract operations.",
  "Contract operations could not be loaded.",
  "Reload",
  "Operations",
  "Filter operations",
  ...
  "Open the runnable API explorer",
