...
export const defaultMessageValues = [
  ...
  "Inventory",
  "No certificates expire this week.",
  "1 certificate needs attention this week.",
  "{count} certificates need attention this week.",
  "The inventory is ready to review by owner, date, or status.",
  "Review the earliest expiry first. Exact fields and renewal controls remain available in the table and certificate details.",
