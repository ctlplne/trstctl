...
export const defaultMessageValues = [
  ...
  "Target",
  "Expires",
  "Read-only posture disclosures: packaging, tenant boundary, transport, scale, support, and the managed offering.",
  ...
  "readyz checks db, nats, and signer; Prometheus scrapes /metrics — System posture summarizes the runtime.",
