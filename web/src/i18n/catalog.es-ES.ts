...
const esESCatalog = {
  ...
  "secrets.wif.createHeading": "Añadir identidad de carga de trabajo de AWS",
  "secrets.wif.created": "Se creó la fuente de identidad de carga de trabajo de AWS.",
  "secrets.wif.delete": "Eliminar",
  "secrets.wif.deleted": "Se eliminó la fuente de identidad de carga de trabajo de AWS.",
  "secrets.wif.deleting": "Eliminando…",
  "secrets.wif.description":
    "Vincule una prueba OIDC de carga de trabajo a un destino de sincronización de AWS. trstctl la intercambia por una credencial de corta duración solo mientras el worker de outbox acotado entrega un secreto.",
  "secrets.wif.edit": "Editar",
  "secrets.wif.editHeading": "Editar identidad de carga de trabajo de AWS",
  "secrets.wif.empty": "No hay identidades de carga de trabajo configuradas",
  "secrets.wif.emptyBody": "Las credenciales estáticas de AWS no cambian hasta que un operador añada explícitamente una fuente aquí.",
  "secrets.wif.enabled": "Habilitar este intercambio",
  "secrets.wif.expiry": "Caducidad de la credencial",
  "secrets.wif.heading": "Federación de identidad de carga de trabajo de AWS",
  "secrets.wif.listLabel": "Fuentes de identidad de carga de trabajo de AWS",
  ...
  "secrets.wif.selectTarget": "Seleccione un destino de AWS",
  ...
  "secrets.wif.target": "Destino de sincronización de AWS",
  ...
  "secrets.wif.updated": "Se actualizó la fuente de identidad de carga de trabajo de AWS.",
