...
const esESCatalog = {
  ...
  "secrets.route.store": "Almacén de secretos",
  ...
  "secrets.route.storeAnswer": "Qué secretos existen, quién es responsable y cuáles necesitan rotación.",
  ...
  "nav.item.tsa": "TSA",
  "nav.item.secrets": "Almacén de secretos",
