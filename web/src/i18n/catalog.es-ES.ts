...
const esESCatalog = {
  ...
  "protocols.dns01.allowUpstreamDVHelp": "Permite que trstctl publique registros _acme-challenge en esta zona en nombre de una AC externa, de forma desatendida, en cada ciclo de validación. Las credenciales añadidas para que trstctl pudiera verificar un desafío no conceden esto.",
  ...
  "source.deployment.truth.help.d3tri00002": "\u00abEntregado\u00bb es el relato de este plano de control sobre lo que hizo. \u00abVerificado\u00bb es lo que un cliente obtiene realmente, establecido mediante un handshake TLS contra el extremo. Una renovaci\u00f3n puede entregarse y no llegar nunca, por eso se cuentan por separado y no se suman.",
  ...
  "protocols.dns01.upstreamUnavailable": "Esta instalación no pudo leer la vigencia de la autorización ascendente, así que nada de lo aquí mostrado debe tomarse como prueba de que la validación esté en buen estado.",
  ...
  "protocols.dns01.upstreamNeverValidatedOne": "1 identificador nunca ha sido validado por esta instalación: cuando se cierre la ventana de reutilización de la autoridad, fallará.",
  "protocols.dns01.upstreamNeverValidatedMany": "{count} identificadores nunca han sido validados por esta instalación: cuando se cierre la ventana de reutilización de la autoridad, fallarán todos a la vez.",
