...
const esESCatalog = {
  ...
  "discovery.ct.coverageHonesty": "Esto cubre solo los dominios y registros configurados a continuaci\u00f3n. No es una cobertura autom\u00e1tica de todo el patrimonio: un dominio que no haya listado, o un registro que no consulte, no produce ning\u00fan hallazgo.",
