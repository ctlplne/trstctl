...
const esESCatalog = {
  ...
  "incidents.fleet.retiredDirectNotice": "La mutación directa de una identidad está retirada: podía revocar sin pruebas exactas de confianza y servicio activo. Previsualice la identidad y fije en el plan de flota consumidores H1, cohortes H2, reversión y CA de reemplazo.",
