...
const esESCatalog = {
  ...
  "certificates.inventoryAnswer.noneTitle": "Ningún certificado caduca esta semana.",
  "certificates.inventoryAnswer.oneTitle": "1 certificado requiere atención esta semana.",
  "certificates.inventoryAnswer.manyTitle": "{count} certificados requieren atención esta semana.",
  "certificates.inventoryAnswer.noneBody": "El inventario está listo para revisar por responsable, fecha o estado.",
  "certificates.inventoryAnswer.attentionBody":
    "Revise primero la caducidad más próxima. Los campos exactos y los controles de renovación siguen disponibles en la tabla y en los detalles del certificado.",
