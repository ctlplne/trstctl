...
const esESCatalog = {
  ...
  "source.target.deploy.listener.verification.and.rollback.38783cea3d": "{target}: evidencias de despliegue, verificación del listener y reversión en el orden registrado por las API servidas.",
