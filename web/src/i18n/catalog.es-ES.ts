...
const esESCatalog = {
  ...
  "nav.spaceQuestion.certificates": "¿Cómo se emiten, renuevan y consideran de confianza los certificados?",
  "nav.module.secrets": "Secretos",
  "nav.spaceQuestion.secrets": "¿Cómo reciben y rotan secretos las máquinas de forma segura?",
  "nav.module.ssh": "SSH",
  "nav.module.signing": "Firma",
  "nav.module.fleet": "Flota",
  "nav.space.workload": "Workloads y SSH",
  "nav.spaceQuestion.workload": "¿Quién es esta máquina y a qué puede acceder?",
  "nav.space.posture": "Postura y respuesta",
  "nav.spaceQuestion.posture": "¿Qué está mal y qué podría verse afectado?",
  "nav.space.platform": "Plataforma",
  "nav.spaceQuestion.platform": "¿Cómo se protege y opera el plano de control?",
