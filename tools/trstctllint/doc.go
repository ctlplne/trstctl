...
//   - licenseboundary (PACKAGING-007): core files carry BUSL-1.1 SPDX, clients/ files carry MPL-2.0, ee/ files carry the proprietary SPDX, and core cannot import ee/ outside the tagged attach seams.
